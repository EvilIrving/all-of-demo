...
public class Constant {
     ...
     * 用户是否管理员 key
     */
    public static final String JWT_USER_ADMIN = "jwt-user-admin-key";
    /**
     * 角色key
     */
     ...
     * 用户权鉴缓存 key
     */
    public static final String IDENTIFY_CACHE_KEY = "shiro-cache:CustomRealm.authorizationCache:";
    /**
     * 默认明文密码
     */
    public static final String DEFAULT_PASSWORD = "ygkj0818";
    /**
     * 超级管理员角色权限
     */
    public static final String SUPER_ADMIN_ROLE_ID = "11b3b80c-4a0b-4a92-96ea-fdd4f7a4a7e9";

    public static final String DEPARTMENT_NAME_KEY = "department";

    public static final String LOGIN_RANK_KEY = "login_rank";

    public static final String DATA_UPDATE_KEY = "data_update_rank";

    public static final String NO_DATA_STRING = "-";

    public static final String EXTERNAL_KEY = "external";

    public static final String VERIFICATION_CODE_KEY = "verification_code_";
}
