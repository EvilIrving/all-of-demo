 ...
 */
@Data
@ApiModel("水闸、测站、水位数据 查询入参")
public class WagaStationWaterReqVo extends PageEntity implements Serializable {

    private static final long serialVersionUID = 5026106802279340934L;
