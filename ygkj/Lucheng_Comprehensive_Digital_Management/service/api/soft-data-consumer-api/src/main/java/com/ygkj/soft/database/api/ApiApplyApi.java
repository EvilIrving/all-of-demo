...
public interface ApiApplyApi {
    ...
    com.ygkj.water.model.CommonResult queryMyAuditTodo(ApiApplyQueryVo queryVO) throws Exception;

    @ApiOperation(value = "我发起的审批记录")
    com.ygkj.water.model.CommonResult queryAuditRecordsFromMe(ApiApplyQueryVo queryVO) throws Exception;

    @ApiOperation(value = "查询审批详情")
    com.ygkj.water.model.CommonResult loadApply(@ApiParam(value = "申请单ID", required = true) String applyId) throws Exception;
