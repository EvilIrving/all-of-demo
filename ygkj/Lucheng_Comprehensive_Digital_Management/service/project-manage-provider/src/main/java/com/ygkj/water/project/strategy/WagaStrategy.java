...
@Component
public class WagaStrategy implements Strategy{

    private ProjectMapper projectMapper;

    public WagaStrategy(@Autowired ProjectMapper projectMapper) {
        this.projectMapper = projectMapper;
    }

    @Override
    public String type() {
        return ProjectTypeEnum.SLUICE.getType();
    }
    ...
    public Collection records(String codes) {
        ...
        return projectMapper.selectWagaByCondition(vo);
    }
