 ...
 */
@Component
public class IrrStrategy implements Strategy{

    private ProjectMapper projectMapper;

    public IrrStrategy(@Autowired ProjectMapper projectMapper) {
        this.projectMapper = projectMapper;
    }

    @Override
    public String type() {
        return ProjectTypeEnum.IRR.getType();
    }
    ...
    public Collection records(String codes) {
        ...
        return projectMapper.selectIrrProjectByCondition(vo);
    }
}
