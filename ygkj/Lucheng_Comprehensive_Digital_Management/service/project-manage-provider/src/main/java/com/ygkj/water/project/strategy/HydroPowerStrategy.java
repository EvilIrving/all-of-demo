 ...
 */
@Component
public class HydroPowerStrategy implements Strategy{

    private ProjectMapper projectMapper;

    public HydroPowerStrategy(@Autowired ProjectMapper projectMapper) {
        this.projectMapper = projectMapper;
    }

    @Override
    public String type() {
        return ProjectTypeEnum.HYDROPOWER.getType();
    }
    ...
    public Collection records(String codes) {
        ...
        return projectMapper.selectHydristByCondition(vo);
    }
}
