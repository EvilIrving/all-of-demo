 ...
 */
@Component
public class PumpStrategy implements Strategy{

    private ProjectMapper projectMapper;

    public PumpStrategy(@Autowired ProjectMapper projectMapper) {
        this.projectMapper = projectMapper;
    }

    @Override
    public String type() {
        return ProjectTypeEnum.PUMP.getType();
    }
    ...
    public Collection records(String codes) {
        ...
        return projectMapper.selectPumpByCondition(vo);
    }
}
