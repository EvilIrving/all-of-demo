 ...
 */
@Component
public class CwsStrategy implements Strategy{

    private ProjectMapper projectMapper;

    public CwsStrategy(@Autowired ProjectMapper projectMapper) {
        this.projectMapper = projectMapper;
    }

    @Override
    public String type() {
        return ProjectTypeEnum.CWS.getType();
    }
    ...
    public Collection records(String codes) {
        ...
        return projectMapper.selectCwsProjectByCondition(vo);
    }
}
