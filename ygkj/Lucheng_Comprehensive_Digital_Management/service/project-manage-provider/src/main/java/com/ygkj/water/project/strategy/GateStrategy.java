 ...
 */
@Component
public class GateStrategy implements Strategy{

    private ProjectMapper projectMapper;

    public GateStrategy(@Autowired ProjectMapper projectMapper) {
        this.projectMapper = projectMapper;
    }

    @Override
    public String type() {
        return ProjectTypeEnum.GATE.getType();
    }
    ...
    public Collection records(String codes) {
        ...
        return projectMapper.selectGateProjectByCondition(vo);
    }
}
