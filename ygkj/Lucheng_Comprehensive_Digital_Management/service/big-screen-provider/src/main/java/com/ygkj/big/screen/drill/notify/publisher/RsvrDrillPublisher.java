...
import com.ygkj.big.screen.drill.notify.event.RsvrDrillEvent;
 ...
 * @Date 2021/7/10
 */
public class RsvrDrillPublisher extends Thread implements Publisher {
...
//        eventType = clazz;
        eventType = RsvrDrillEvent.class;
