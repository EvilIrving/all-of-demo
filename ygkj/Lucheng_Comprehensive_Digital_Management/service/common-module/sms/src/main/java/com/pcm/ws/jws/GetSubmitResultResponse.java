...
/**
 * <p>getSubmitResultResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="getSubmitResultResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getSubmitResultResponse", propOrder = {
    "_return"
})
public class GetSubmitResultResponse {
