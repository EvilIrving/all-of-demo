...
/**
 * <p>getSentResultSmsResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="getSentResultSmsResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getSentResultSmsResponse", propOrder = {
    "_return"
})
public class GetSentResultSmsResponse {
