...
/**
 * <p>getSentTaskResultCallResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="getSentTaskResultCallResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getSentTaskResultCallResponse", propOrder = {
    "_return"
})
public class GetSentTaskResultCallResponse {
