					...
					<div class="collapse-panel__content">
						...
						<panel-item title="短临预报" hasSwitch>
							...
							<div class="sidebar-list switch-list">
								<el-carousel height="200px" trigger="click" arrow="never" :autoplay="false">
									<el-carousel-item>
										<!-- 短临预报降雨极值列表 -->
...
export default {
	...
	methods: {
		...mapActions(["changeArea", "changeBasin", "getForecastRainfallLayer", "setCollapseLeft", "changeScreenLoading"]),
