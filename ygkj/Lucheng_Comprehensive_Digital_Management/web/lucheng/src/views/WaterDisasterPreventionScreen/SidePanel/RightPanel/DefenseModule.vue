			...
			<div class="collapse-panel__content">
				<panel-item :inSimulation="previewModule" title="水库" has-switch>
                  ...
                  "
					...
					<!-- 小（II）型 -->
					<div style="margin-bottom: 10px" :class="[resSelect.小Ⅱ型 == true ? 'reservoir-style' : '']">
						<div class="area-style" style="margin-bottom: 10px" @click="reservoirType('小（Ⅱ）型', '小Ⅱ型')">
					...
					<div class="water-gate-sty">
						...
						<div class="area-style">
							<p>
								...
								><span style="font-size: 17px; color: #fff; line-height: 2.125rem">累计:</span>
								<el-input-number
									v-model="num"
									size="small"
									...
									@input="changeHours"
								/>
								<span style="font-size: 17px; color: #fff; line-height: 2.125rem">小时</span>
							</p>
				...
				>
					...
					<template #title-switch>
						<i
							...
							:class="[fxyhBtn == true ? 'icon-yinzhang-active' : 'icon-yinzhang-1', 'icon-sty']"
						/>
					...
					<div>
						<el-row style="margin-top: 6px">
							...
							<el-col :span="12" class="hydrops-sty" style="padding-top: 15px; overflow-y: auto">
								<div>
...
export default {
	...
	methods: {
		...
		async rsvrProjStats2(val, flag) {
			...
			if (flag) {
				(obj.drill = true), (obj.dataTime = new Date(this.formatterCurrentTime()).format("yyyy-MM-dd hh:mm:ss"));
			}
