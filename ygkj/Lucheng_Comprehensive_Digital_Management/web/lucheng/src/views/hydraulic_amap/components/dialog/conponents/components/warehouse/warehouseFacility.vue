<!--
 * @Author: dengzhao
 * @LastEditTime: 2022-05-31 15:33:30
 * @Description: 
 * @FilePath: \lucheng\src\views\hydraulic_amap\components\dialog\conponents\components\warehouse\warehouseFacility.vue
-->
<template>
  <div>
...
import {
  ...
  LabelFormItem,
  DataDetailButton
} from '@/views/water_disaster_custom/dialog/DetailsCommonDialog/components';
