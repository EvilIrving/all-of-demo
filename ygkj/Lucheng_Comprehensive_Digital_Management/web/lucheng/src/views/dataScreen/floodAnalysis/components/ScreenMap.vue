  ...
  <div class="map-wrap">
    ...
    <div id="popup1" class="ol-popup-rain">
      ...
      <div class="sidebar-tab">
        <span v-for="(item, index) in tabArr" :key="index" :class="{ active: tabActive == item.id }" @click="handleClick(item.id)" :title="item.tit">{{ item.tit }}</span>
      </div>
      <div class="content" v-if="resize">
        <line-chart v-if="tabActive == 1" :setting="setting" :chartData="chartData" :subtext="subtext" :chartMarkLine="chartMarkLine"></line-chart>
