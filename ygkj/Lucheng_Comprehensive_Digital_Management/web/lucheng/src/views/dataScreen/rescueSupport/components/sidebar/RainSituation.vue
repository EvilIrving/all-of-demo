  ...
  <div class="sidebar-box">
    ...
    <div class="sidebar-list">
      ...
      >
        ...
        <el-table-column prop="drp" label="雨量(mm)"></el-table-column>
...
export default {
  ...
  computed: {
    tableData: {
      get() {
        return this.$store.state.rainList;
      },
      set(val) {
        this.tableData = val;
      },
  ...
  mounted() {
    if (this.tableData.length === 0) {
      ...
      this.$parent.$refs.map.showRainPoint(this.tableData);
    }
  },
  methods: {
    async getList() {
      ...
      // this.$store.dispatch("getRainList", {
      //   params: {
      ...
      //   callback: (list) => {
      //     that.loading = false;
      //     that.$parent.$refs.map.showRainPoint(list);
      //   },
      // });
    },
    handleClick(val) {
