	...
	<div class="big-card">
		<panel-item title="灌区" hasSwitch tc @tclick="tclick">
			<template #title-switch>
				...
				<i @click="goToAMap('灌区')" title="一张图" class="icon-yizhangtu icon-sty" />
			</template>
			<!-- 灌区类型统计-->
			<div class="tab-type">
				<card-tabs
		...
		<IrrigateDetail v-if="detailVisible" type="灌区" :visible="detailVisible" @close="closeDetail"></IrrigateDetail>
	</div>
</template>
