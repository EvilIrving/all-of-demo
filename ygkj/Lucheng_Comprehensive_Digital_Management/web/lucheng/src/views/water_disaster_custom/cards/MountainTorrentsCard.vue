...
export default {
  ...
  methods: {
    ...
    renderPanelLeft() {
      ...
      .mountainTorrentBaseStats()
      .then((res) => {
        if (res.code == 0) {
          this.involveCounty =res.data.involveCounty
          this.prevTown =res.data.prevTown
          this.prevVillage =res.data.prevVillage
          this.effectPop =res.data.effectPop
        }
        ...
        <el-carousel-item class="torrent-total-info__page">
          <div class="page-item">
            ...
            <div class="page-item__data">
              <span prop="involveCounty" class="number">{this.involveCounty}</span>
          ...
          <div class="page-item">
            ...
            <div class="page-item__data">
              <span prop="prevTown" class="number">{this.prevTown}</span>
              <span class="unit">个</span>
            </div>
          </div>
          <div class="page-item">
            ...
            <div class="page-item__data">
              <span prop="prevVillage" class="number">{this.prevVillage}</span>
              <span class="unit">个</span>
            </div>
          </div>
          <div class="page-item">
            ...
            <div class="page-item__data">
              <span prop="effectPop" class="number">{this.effectPop}</span>
    ...
    renderPanelRight() {
      ...
      .then((res) => {
        if (res.code == 0) {
          this.prevAreaNum =res.data.prevAreaNum
          this.dangerArea =res.data.dangerArea
          this.highDangerArea =res.data.highDangerArea
          this.superDangerArea =res.data.superDangerArea
      ...
      return (
        <el-carousel-item class="torrent-total-info__page">
          <div class="page-item">
            ...
            <div class="page-item__data">
              <span class="number">{this.prevAreaNum}</span>
              <span class="unit">个</span>
            </div>
          </div>
          <div class="page-item">
            ...
            <div class="page-item__data">
              <span prop="dangerArea" class="number">{this.dangerArea}</span>
              <span class="unit">个</span>
            </div>
          </div>
          <div class="page-item">
            ...
            <div class="page-item__data">
              <span prop="highDangerArea" class="number">{this.highDangerArea}</span>
              <span class="unit">个</span>
            </div>
          </div>
          <div class="page-item">
            ...
            <div class="page-item__data">
              <span prop="superDangerArea" class="number">{this.superDangerArea}</span>
              <span class="unit">个</span>
            </div>
          </div>
        </el-carousel-item>
