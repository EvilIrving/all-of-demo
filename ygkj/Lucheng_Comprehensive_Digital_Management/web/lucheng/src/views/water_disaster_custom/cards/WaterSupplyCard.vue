...
<template>
	<div class="water-card">
				...
				<el-dropdown placement="bottom-start" trigger="click">
					...
					<el-dropdown-menu slot="dropdown" class="year-dropdown">
						<el-dropdown-item v-for="(item, index) in yearOption" :key="index">
							<el-radio v-model="checkYear" :label="item" @change="handleYear">{{ item }}</el-radio>
						</el-dropdown-item>
					</el-dropdown-menu>
				</el-dropdown>
				<!-- <i
        ...
        /> -->
				<i title="查看详表" class="icon-liebiao icon-sty" @click.stop="openDetailsDialog('供水量')" />
			</template>
			...
			<div class="area-box" v-if="activeTab == 0">
				<div class="pie-chart-panel">
					...
					<div class="legend-panel">
						<div class="legend-item" v-for="(item, index) in waterSupplyData.rows" :key="index">
							<i
			...
			<div class="area-box" v-if="activeTab == 1">
				<div class="pie-chart-panel">
					<div id="waterSupplyProjEchart" style="width: 100%; height: 100%"></div>
					<div class="legend-panel">
						<div class="legend-item" v-for="(item, index) in waterSupplyProjData.rows" :key="index">
							<i
								style="vertical-align: middle"
								:class="[
									'icon-sty',
				...
				series: [
					{
						...
						label: {
							...
							normal: {
								...
								color: "#fff",
								fontSize: 14,
								formatter: this.waterSupplyProjData.totalLength + "个\n" + "总量" // {b}:数据名； {c}：数据值； {d}：百分比，可以自定义显示内容，
							}
						},
						labelLine: {
							show: false
