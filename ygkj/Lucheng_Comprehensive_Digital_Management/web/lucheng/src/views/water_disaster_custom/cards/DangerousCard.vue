 ...
 * @LastEditTime: 2021-12-03 17:37:25
 * @LastEditors: dtb
 * @Description: 病险小组件
 * @FilePath: \lucheng\src\views\water_disaster_custom\cards\DangerousCard.vue
-->
<template>
	<div class="dangerous-card">
		<panel-item title="病险工程" has-switch>
			...
			<el-row class="risk-container" style="letter-spacing: 2px; padding: 0 16px; height: 100%">
				<el-col
					:span="12"
