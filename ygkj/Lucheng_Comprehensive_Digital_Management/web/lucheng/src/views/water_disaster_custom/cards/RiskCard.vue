 ...
 * @LastEditTime: 2022-09-22 15:36:30
 * @LastEditors: Please set LastEditors
 * @Description: 风险小组件
 * @FilePath: \lucheng\src\views\water_disaster_custom\cards\RiskCard.vue
-->
<template>
  <div class="risk-card">
    <panel-item
    ...
    return {
      ...
      projRiskExtraOption: {
        tooltip: {
          ...
          confine: true,
          extraCssText: 'font-size:16px; color:#ffffff'
        },
        color: [
          {
            type: 'linear',
  ...
  methods: {
    ...
    handleRiskChange(btnType) {
      ...
      let style = {
        ...
        anchor: [24, 24],
        anchorXUnits: 'pixels',
        srcs: require('@/assets/new_images/point/risk-group.png'),
        src: require('@/assets/new_images/point/risk-point.png')
      };
      let style1 = {
        scale: 1,
        anchor: [24, 24],
        anchorXUnits: 'pixels',
        srcs: require('@/assets/new_images/point/hiddentrouble-group.png'),
        src: require('@/assets/new_images/point/hiddentrouble-point.png')
      };
      let style2 = {
        scale: 1,
        anchor: [24, 24],
        anchorXUnits: 'pixels',
        srcs: require('@/assets/new_images/point/weakness-group.png'),
        src: require('@/assets/new_images/point/weakness-point.png')
      };
