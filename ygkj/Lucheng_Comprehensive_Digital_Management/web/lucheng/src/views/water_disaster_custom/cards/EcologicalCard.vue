	...
	<div class="ecological-card">
		<panel-item title="流域生态流量" has-switch tc @tclick="tclick">
			...
			<div class="ecological-card-content">
				...
				<div class="chart-box">
					<EchartPie ref="chartCapsule" :seriesData="statisticData"></EchartPie>
				</div>
			</div>
		</panel-item>
		<SectionFlowDetail :visible.sync="detailVisible" />
	</div>
</template>
...
import SectionFlowDetail from "./dialog/SectionFlowDetail.vue";
export default {
	name: "EcologicalCard",
	layerName: ["warnfractureLayer", "normalfractureLayer", "errorfractureLayer"],
	legendName: "断面",
	components: { PanelItem, CardTabs, EchartPie, SectionFlowDetail },
	created() {
