 ...
 * @LastEditTime: 2022-06-15 15:18:29
 * @LastEditors: dtb
 * @Description: 潮位小组件
 * @FilePath: \lucheng-appe:\lucheng-comprehensive\web\lucheng\src\views\water_disaster_custom\cards\TideCard.vue
-->
<template>
	<div class="tide-card">
		<panel-item
		...
		>
			<template #title-switch>
				...
				/>
				<i v-show="!previewModule" @click="goToAMap('潮位')" title="一张图" class="icon-yizhangtu icon-sty" />
			</template>
			<!-- tab切换 -->
					...
					<el-carousel-item>
						...
						<el-row class="sea-level-style">
							<el-col :span="8" class="sea-level-sty">
								<div class="sea-sty" v-if="astroTideData[0] && astroTideData[0].amMax.tm">
									<p>
										{{ astroTideData[0] && astroTideData[0].amMax.tm && astroTideData[0].amMax.tm.slice(11, 16) }}
										<i class="icon-shang-sheng icon-sty" />{{ astroTideData[0] && astroTideData[0].amMax.tdz }}
										m
									</p>
								</div>
								<div class="sea-sty" v-if="astroTideData[0] && astroTideData[0].amMin.tm">
									<p>
										{{ astroTideData[0] && astroTideData[0].amMin.tm && astroTideData[0].amMin.tm.slice(11, 16) }}
							...
							<el-col :span="8" class="sea-level-sty sea-left-level-style">
								<div class="sea-sty" v-if="astroTideData[1] && astroTideData[1].amMax.tm">
									<p>
										{{ astroTideData[1] && astroTideData[1].amMax.tm && astroTideData[1].amMax.tm.slice(11, 16) }}
										<i class="icon-shang-sheng icon-sty" />{{ astroTideData[1] && astroTideData[1].amMax.tdz }}
										m
									</p>
								</div>
								<div class="sea-sty" v-if="astroTideData[1] && astroTideData[1].amMin.tm">
									<p>
										{{ astroTideData[1] && astroTideData[1].amMin.tm && astroTideData[1].amMin.tm.slice(11, 16) }}
							...
							<el-col :span="8" class="sea-level-sty">
								<div class="sea-sty" v-if="astroTideData[2] && astroTideData[2].amMax.tm">
									<p>
										{{ astroTideData[2] && astroTideData[2].amMax.tm && astroTideData[2].amMax.tm.slice(11, 16) }}
										<i class="icon-shang-sheng icon-sty" />{{ astroTideData[2] && astroTideData[2].amMax.tdz }}
										m
									</p>
								</div>
								<div class="sea-sty" v-if="astroTideData[2] && astroTideData[2].amMin.tm">
									<p>
										{{ astroTideData[2] && astroTideData[2].amMin.tm && astroTideData[2].amMin.tm.slice(11, 16) }}
						...
						<el-row>
							<el-col :span="8" class="sea-level-sty">
								<div class="sea-sty" v-if="astroTideData[0] && astroTideData[0].pmMax.tm">
									<p>
										{{ astroTideData[0] && astroTideData[0].pmMax.tm && astroTideData[0].pmMax.tm.slice(11, 16) }}
										<i class="icon-shang-sheng icon-sty" />{{ astroTideData[0] && astroTideData[0].pmMax.tdz }}
										m
									</p>
								</div>
								<div class="sea-sty" v-if="astroTideData[0] && astroTideData[0].pmMin.tm">
									<p>
										{{ astroTideData[0] && astroTideData[0].pmMin.tm && astroTideData[0].pmMin.tm.slice(11, 16) }}
							...
							<el-col :span="8" class="sea-level-sty sea-left-level-style">
								<div class="sea-sty" v-if="astroTideData[1] && astroTideData[1].pmMax.tm">
									<p>
										{{ astroTideData[1] && astroTideData[1].pmMax.tm && astroTideData[1].pmMax.tm.slice(11, 16) }}
										<i class="icon-shang-sheng icon-sty" />{{ astroTideData[1] && astroTideData[1].pmMax.tdz }}
										m
									</p>
								</div>
								<div class="sea-sty" v-if="astroTideData[1] && astroTideData[1].pmMin.tm">
									<p>
										{{ astroTideData[1] && astroTideData[1].pmMin.tm && astroTideData[1].pmMin.tm.slice(11, 16) }}
							...
							<el-col :span="8" class="sea-level-sty">
								<div class="sea-sty" v-if="astroTideData[2] && astroTideData[2].pmMax.tm">
									<p>
										{{ astroTideData[2] && astroTideData[2].pmMax.tm && astroTideData[2].pmMax.tm.slice(11, 16) }}
								...
								<div class="sea-sty" v-if="astroTideData[2]">
									<p>
										{{ astroTideData[2] && astroTideData[2].pmMin.tm && astroTideData[2].pmMin.tm.slice(11, 16) }}
