<!--
 * @Author: dengzhao
 * @LastEditTime: 2022-04-07 17:39:30
 * @Description: 
 * @FilePath: \lucheng\src\views\water_disaster_custom\dialog\SluiceDialogForSchedule\components\components\flow.vue
-->
<template>
  <div class="water-box">
    <div class="query-box">
  ...
  methods: {
    ...
    getWaterLevels() {
      ...
      waterAndRain.waterLevels({
        ...
        this.chartWaterData.columns = ['时间', '实时流量'];
        info.map((item) => {
          item['时间'] = item.tm;
          // item['闸上水位'] = item.upz;
