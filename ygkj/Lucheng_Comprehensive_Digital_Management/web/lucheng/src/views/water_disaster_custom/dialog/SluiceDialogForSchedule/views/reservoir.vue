 ...
 * @LastEditTime: 2022-04-08 16:27:28
 * @FilePath: \lucheng\src\views\water_disaster_custom\dialog\SluiceDialogForSchedule\views\reservoir.vue
-->
<template>
  <div class="seawall-box">
    ...
    <div class="seawall-content">
      <reservoir-index :pointData="pointData" v-if="tapOptions == 0" />
      <monitoring :pointData="pointData" type='水库' v-if="tapOptions == 1" />
