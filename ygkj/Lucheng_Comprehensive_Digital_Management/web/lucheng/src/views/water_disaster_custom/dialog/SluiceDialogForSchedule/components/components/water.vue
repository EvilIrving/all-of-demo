<!--
 * @Author: dengzhao
 * @LastEditTime: 2022-04-08 14:34:03
 * @Description: 
 * @FilePath: \lucheng\src\views\water_disaster_custom\dialog\SluiceDialogForSchedule\components\components\water.vue
-->
<template>
  <div class="water-box">
    <div class="query-box">
...
export default {
  ...
  mounted() {
    console.log(this.pointData, 'this.pointDatathis.pointDatathis.pointData');
    if (this.type == '水库') {
      this.columnList =[
        {
          prop: 'tm',
