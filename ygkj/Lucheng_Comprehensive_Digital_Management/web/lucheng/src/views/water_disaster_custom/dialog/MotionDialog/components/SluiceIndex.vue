 ...
 * @Description: 
 * @LastEditors: dtb
 * @LastEditTime: 2022-05-23 14:01:26
 * @FilePath: \lucheng\src\views\water_disaster_custom\dialog\SluiceDialogForSchedule\components\SluiceIndex.vue
-->
<template>
  <div class="seawall">
      ...
      <div class="alarm">
        ...
        <div class="alarm-box flex-box">
          <div class="alarm-box-one">
            <div class="alarm-box-title">水闸超警</div>
...
export default {
  ...
  computed: {},
  mounted() {
    console.log(this.pointData, 'pointDatapointDatapointDatapointDatapointData');
    this.getContactList();
    this.getProjectInfo();
  ...
  methods: {
    ...
    getProjectInfo() {
      hydraulicApi
        .getProjects({ withWaterLevel: false, type: '水闸', code: this.pointData.projectCode || '' })
        .then((res) => {
