    ...
    <DataDetailDialog :visible.sync="visible" :before-close="handleClose" class="detail-table" :title="pointData.name">
      ...
      <div class="new_box">
        <div class="sluice_flex" v-if="pointData.stType == 'DD'">
          ...
          <ProjectInfo v-if="tabAction===0" :responsibleList='contactList' :propList='propList' :type='pointData.type' />
          <ProjectVideo v-if="tabAction===1" :code='pointData.code' />
          <CustomIframe :src="frameUrl" v-if="tabAction===2" />,
          <!-- <RunningInfo v-if="tabAction===3" :type='pointData.type' :stationCode='pointData.stCode' /> -->
          <div class="new_box_item" v-if="tabAction===3">
            <div class="left">
              <div>
