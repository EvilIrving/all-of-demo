 ...
 * @LastEditTime: 2022-04-08 15:48:56
 * @FilePath: \lucheng\src\views\water_disaster_custom\dialog\SluiceDialogForSchedule\views\embankment.vue
-->
<template>
  <div class="seawall-box">
    ...
    <div class="seawall-content">
      <embankment-index :pointData="pointData" v-if="tapOptions == 0" />
      <monitoring :pointData="pointData" type='堤防' v-if="tapOptions == 1" />
...
import EmbankmentIndex from '../components/EmbankmentIndex.vue';
...
export default {
  ...
  methods: {
    switchTap(index) {
      ...
      if (index === 2) {
        this.frameUrl = `https://sk.zjwater.com/cp/skip/reservoirDetailSingle?prcd=${this.pointData.projectCode
