<!--
 * @Author: dengzhao
 * @LastEditTime: 2022-03-08 14:53:55
 * @Description: 
 * @FilePath: /lucheng/src/views/water_disaster_custom/dialog/DetailsCommonDialog/components/cardListDetail/seawallCardList/components/components/PagePatrol.vue
-->
<template>
