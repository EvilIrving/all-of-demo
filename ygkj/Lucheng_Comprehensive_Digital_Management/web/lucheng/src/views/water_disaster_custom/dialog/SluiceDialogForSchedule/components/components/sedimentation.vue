<!--
 * @Author: dengzhao
 * @LastEditTime: 2022-04-02 13:51:45
 * @Description: 
 * @FilePath: \lucheng\src\views\water_disaster_custom\dialog\SluiceDialogForSchedule\components\components\sedimentation.vue
-->
<template>
  <div class="water-box">
    <div class="query-box">
