<template>
  <keep-alive>
    <div class="home">
      <main-header @menuClick="menuClick"></main-header>
      <div :class="[
          'page-content',
          'clearfix',
              ...
              <div :key="index">
                <li @click="secondMenuClick(index, item.url, item.children)">
                  ...
                  <el-collapse-transition>
                    <ul class="third-menu" v-if="item.children" v-show="index === secondMenuSelected">
                      <li @click.stop="thirdMenuClick(index, child.url)" v-for="(child, index) in item.children" :key="index" :class="[thirdMenuSelected === index ? 'active' : '']">
