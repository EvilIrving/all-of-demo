...
export const disasterPreventionApi = {
	...
	// 对海塘工程分页统计
// 供水量-用水量年度对比表-表头统计
stats4WatSupplyConsumeCompareList: function(data) {
	return http.get("wra/wrbWaterSupply/stats4WatSupplyConsumeCompareList", data);
},
// 供水量-用水量年度对比表
watSupplyConsumeCompareList: function(data) {
	return http.get("wra/wrbWaterSupply/watSupplyConsumeCompareList", data);
},
// 积水点积水次数热力图
floodPointHeatMap: function(data) {
	return http.get("flood-protect/waterLogging/floodPointHeatMap", data);
},
	stats4PageSeawall: function(data) {
		return http.get("project-manage/seawall/stats4PageSeawall", data);
	},
	// 潮位
	...
	// 积水点C位统计
	floodPointCWindows: function(data) {
		return http.get("/big-screen/waterDisasterPrevention/floodPointCWindows", data);
	},
	// 积水统计
	...
	floodRiskList: function(data) {
		return http.post("/digitization/FloodRiskDisasterData/loadPage", data);
	}
};