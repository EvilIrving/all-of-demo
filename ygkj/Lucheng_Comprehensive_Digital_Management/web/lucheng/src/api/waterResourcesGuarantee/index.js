...
export const waterResourceApi = {
  ...
  table4WrbRainfall: function (data) {
    return http.get("/wra/wrbRainfall/wrbRainfallList", data);
  },
  /**
   * 降水量公报详表-表头统计
   */
  stats4WrbRainfallList: function (data) {
    return http.get("/wra/wrbRainfall/stats4WrbRainfallList", data);
  },
  /**
   * 水资源统计
   */
  ...
  table4WrbWaterSupply: function (data) {
    return http.get("/wra/wrbWaterSupply/table4WrbWaterSupply", data);
  },
  /**
   * 供水量表头统计
   */
  stats4WrbWaterSupplyWrbWaterSupply: function (data) {
    return http.get("/wra/wrbWaterSupply/stats4WrbWaterSupply", data);
  },
  /**
   * 用水量统计
   */
  ...
  wiuUnit4CWindow: function () {
    return http.post("hydrology-digitization/droughtAnalysis/droughtWraning");
  },
   ...
   * 抗旱监管 统计
   */
  droughtWraning: function (data) {
    return http.post("hydrology-digitization/droughtAnalysis/droughtWraning", data);
  },
  /**
   * 取水监管许可统计
   */
   ...
   * 新街口
   */
  pagePrecedeAffectRainfall: function (data) {
    return http.get("/graph/waterAndRain/pagePrecedeAffectRainfall", data);
  },
  /**
   * 前期影响雨量列表-详表统计
   */
  stats4PrecedeAffectRainfall: function (data) {
    return http.get("/graph/waterAndRain/stats4PrecedeAffectRainfall", data);
  },
  /**
   * 前期影响雨量C位
   */
   ...
   * 防汛超警统计
   */
  waterLevelWarnCount: function (data) {
    return http.get("/project-manage/projectRel/waterLevelWarnCount", data);
  },
  /**
    * 防汛超警列表
    */
  waterLevelWarn: function (data) {
    return http.post("/project-manage/projectRel/waterLevelWarn", data);
  },
  /**
* 海塘报警数量
*/
  seawallGiveAnAlarm: function (data) {
    return http.get("/big-screen/giveAnAlarm/seawallGiveAnAlarm", data);
  },
  /**
* 防汛超警列表
*/
  seawallWarning: function (data) {
    return http.get("/big-screen/giveAnAlarm/seawallWarning", data);
  },
  /**
* 位移沉降报警数量
*/
  displacemen: function (data) {
    return http.get("/big-screen/giveAnAlarm/displacement", data);
  },
  /**
* 工程运行统计
*/
  listRuntimeWarn: function (data) {
    return http.get("/project-manage/projectRel/listRuntimeWarn", data);
  },
  /**
* 防汛风险C位
*/
  floodRiskCenter: function (data) {
    return http.post("/project-manage/projectRel/floodRiskCenter", data);
  },
};
...
export const riskMonitoring = {
  ...
  //近15天天气预报
  listJsonForWeather: function (data) {
    return http.get('/meteorological-visualization/weatherPredict/listJsonForWeather', data);
  },
  //近30日降雨量
  listDayRainfall: function (data) {
    return http.get('/hydrology-digitization/droughtAnalysis/listDayRainfall', data);
  },
  //水电站落点
  hysDropPoint: function (data) {
    return http.get('/big-screen/hystComponent/dropPoint', data);
  },
  //水电站落点弹窗
  getFlowCurve: function (data) {
    return http.post('/big-screen/hystComponent/getFlowCurve', data);
  },
  //水质站落点
  qualityList: function (data) {
    return http.get('/graph/waterQualityV2/list', data);
  },
  //水质站落点弹窗
  qualityCurve: function (data) {
    return http.post('/graph/waterQualityV2/qualityCurve', data);
  },
  //控运是否超警查询
  waterLevelWarn: function (data) {
    return http.post('/project-manage/projectRel/waterLevelWarn', data);
