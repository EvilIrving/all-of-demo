<template>
  <div class="video-player">
    ...
    <div class="down" v-else>
      ...
      <a class="download" href="https://file.ygwjg.com/app/VideoWebPlugin.exe">下载</a>
    </div>
  </div>
</template>
<script>
  ...
  export default {
    ...
    methods: {
      ...
      init() {
        this.getPubKey(() => {
          var appkey = "29928325";
          var ip = "192.168.71.240";
          var port = 446;
          var secret = this.setEncrypt("MV0ywMO5YClPf5YV34Ao");
          var layout = "1x1";
          var enableHTTPS = 1;
          var playMode = 0;
        ...
        oWebControl
          .JS_RequestInterface({
            ...
            argument: JSON.stringify({
              ...
              //cameraIndexCode: '05a9db64dde14b779ede33603c1dbd3d',
      ...
      cuttingPartWindow(left, top, width, height) { oWebControl && oWebControl.JS_CuttingPartWindow(left, top, width, height); },
      repairPartWindow(left, top, width, height) { oWebControl && oWebControl.JS_RepairPartWindow(left, top, width, height); },
      hideCamera() {
        if (oWebControl != null) {
