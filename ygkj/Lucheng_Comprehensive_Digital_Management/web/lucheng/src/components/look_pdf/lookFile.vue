<template>
  <el-dialog :visible.sync="visible" width="74%" center :before-close="close" top="5vh" title="预览文件" class="list-dialog preview-pdf" :append-to-body="appendType" :close-on-click-modal="true">
    <div class="preview-body">
      <div class="pdf" v-if="type == 'pdf'">
        <pdf v-for="item in numPages" :key="item" :src="src" :page="item" />
      </div>
      <div class="pdf" v-else v-viewer>
        <img :src="fileSrc" style="width: 100%;">
        <p style="text-align:center">点击图片可放大</p>
        <!-- <iframe :src="fileSrc" frameborder="0" style="width: 100%; height: 100%"></iframe> -->
      </div>
    </div>
    <div slot="footer">
      <el-row>
...
export default {
  ...
  methods: {
    ...
    //           });
    //         });
    //         this.getNumPages(this.fileList[0].url);
