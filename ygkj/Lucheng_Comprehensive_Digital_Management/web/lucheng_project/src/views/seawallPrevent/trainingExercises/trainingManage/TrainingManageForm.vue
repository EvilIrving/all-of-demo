<!--
 * @Author: hanyu
 * @LastEditTime: 2021-11-05 18:02:44
 * @Description: 
 * @FilePath: \lucheng_project\src\views\seawallPrevent\trainingExercises\trainingManage\TrainingManageForm.vue
-->
<template>
  <div class="wrap-form-box">
    <el-form :rules="rules" ref="form" :model="form" label-width="100px">
      <div class="training-form-box">
        <el-form-item label="演练时间：" prop="tm">
          <el-date-picker
            type="datetime"
            placeholder="请选择"
            v-model="form.tm"
      ...
      <el-form-item label="参与人员：" prop="person">
        <el-input v-model="form.person" placeholder="请输入"></el-input>
      </el-form-item>
      <el-form-item label="演练事由：" prop="reasons">
        <el-input
          type="textarea"
...
export default {
  ...
  methods: {
    ...
    async getDetail() {
      let res = await trainingExercisesApi.rehearsalDetail({ id: this.id });
      console.log(res);
      if (res.code == 0) {
        let { address, filename, fileurl, person, reasons, tm, id } = res.data;
        this.form = {
          address,
          filename,
          fileurl,
