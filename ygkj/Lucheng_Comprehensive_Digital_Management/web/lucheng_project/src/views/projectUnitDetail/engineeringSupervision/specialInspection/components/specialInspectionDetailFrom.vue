<!--
 * @Author: wanxin
 * @LastEditTime: 2022-05-21 11:56:14
 * @Descripttion: 
 * @FilePath: \lucheng_project\src\views\projectUnitDetail\engineeringSupervision\specialInspection\components\specialInspectionDetailFrom.vue
-->
<template>
  <div>
    <div class="wrap">
      ...
      <el-row>
        <el-col :span="24">存在问题</el-col>
      </el-row>
      <el-row>
        <el-col :span="24"
          ><span>{{ problemDesc }}</span></el-col
        >
      </el-row>
    </div>
    <!-- <div class="wrap">
  ...
  methods: {
    async getDetail() {
      ...
      if (res.code == 0) {
        ...
        this.date = data.checkTm
        this.checkUser = data.unitPrincipal
        this.problemDesc = data.checkContent
