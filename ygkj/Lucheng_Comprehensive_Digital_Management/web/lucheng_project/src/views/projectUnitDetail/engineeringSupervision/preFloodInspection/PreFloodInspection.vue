<!--
 * @Author: wanxin
 * @LastEditTime: 2022-07-01 15:05:57
 * @Descripttion: 
 * @FilePath: \lucheng_project\src\views\projectUnitDetail\engineeringSupervision\preFloodInspection\PreFloodInspection.vue
-->
<template>
  <div class="wrap">
    ...
    <div class="list_search_box">
      ...
      <div class="search_right">
        <el-button
          type="primary"
          v-permission="'preFloodInspection:export'"
          @click="exportsData"
          >导出</el-button
        >
        ...
        >
          <template slot-scope="scope">
            <img
              ...
              @click="
                lookFile(scope.row.projCheckRecordFiles, scope.row.sourceType)
              "
              src="../../../../assets/images/c_att.png"
              alt=""
            />
          ...
          <template slot-scope="scope">
            <div class="deal_box">
              <span
                ...
                v-permission="'preFloodInspection:look'"
              ...
              <span
                ...
                v-permission="'preFloodInspection:edit'"
                >编辑</span
              >
              <span
                class="deal_btn deal_btn_del"
                @click="del(scope.row.id)"
                v-permission="'preFloodInspection:del'"
                >删除</span
              >
            </div>
          </template>
    ...
    <el-dialog
      ...
      width="960px"
    >
      <pre-flood-inspection-detail-from
        v-if="projectDialog"
        :id="id"
...
import { exportLgMpFc } from "@/utils/export.js";
import preFloodInspectionAddFrom from "./components/preFloodInspectionAddFrom.vue";
import preFloodInspectionDetailFrom from "./components/preFloodInspectionDetailFrom.vue";
...
export default {
  ...
  components: {
    preFloodInspectionAddFrom,
    preFloodInspectionDetailFrom,
    LookFile,
  },
  mounted() {
    this.getBhLgMpFcList();
  },
  methods: {
    async getBhLgMpFcList() {
      await preFloodInspectionApi
        .bhLgMpFcList({
          date: this.date,
