<!--
 * @Author: wanxin
 * @LastEditTime: 2022-05-20 22:02:04
 * @Descripttion: 
 * @FilePath: \lucheng_project\src\views\projectUnitDetail\engineeringSupervision\specialExamination\components\specialExaminationAddFrom.vue
-->
<!--
 * @Author: wanxin
  ...
  <div>
    ...
    >
      <div class="form-item">
        ...
        <el-form-item label="组织单位：" prop="unitName">
          <el-input
            class="form-item-value"
      ...
      <el-form-item label="存在问题：" prop="problemDesc">
        <el-input
          class="form-item-value"
          type="textarea"
          v-model="ruleForm.problemDesc"
        ></el-input>
      </el-form-item>
      <div class="form-item">
...
export default {
  ...
  methods: {
    ...
    async getLoadPageDisDom() {
      let res = await specialExaminationApi.mpSpList({
