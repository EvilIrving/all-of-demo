 ...
 * @LastEditTime: 2022-08-17 15:01:41
 * @FilePath: \lucheng-app\src\views\appView\acceptance\Acceptance.vue
-->
<template>
  <div class="project-wrap">
    <van-nav-bar fixed placeholder safe-area-inset-top :title="'验收审批'" :left-arrow="$store.state.viewType !== 'irs'" @click-left="$router.go(-1)" />
        ...
        >
          ...
          <div class="card-box">
            ...
            <div class="card-item">
              ...
              <div class="card-item-value">{{ item.runUnitReviewerName }}</div>
            </div>
            <div class="card-item">
