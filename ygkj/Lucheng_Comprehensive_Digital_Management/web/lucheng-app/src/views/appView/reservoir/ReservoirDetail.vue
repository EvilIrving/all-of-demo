 ...
 * @LastEditTime: 2023-01-03 13:49:53
...
<template>
  <div class="project-wrap">
    <van-nav-bar
      ...
      placeholder
      safe-area-inset-top
      :title="$localData('get', 'engineeringInfo').name"
      ...
      <div class="project-detail" v-if="showModel == 'big'">
        <div class="detail-title" v-if="type !== '山塘'">
          <div class="title-name">
            ...
            <span
              >{{
                projectDetail.engScal ||
                projectDetail.dikeGrad ||
                projectDetail.seawallLevel
              }}{{ type }}</span
            >
          </div>
          <div class="title-dec">
            <span>{{
              projectDetail.safetyConclusion ||
              projectDetail.wagaType ||
              projectDetail.dikeType
            }}</span>
            <span>{{
              projectDetail.areaName ||
              projectDetail.village ||
              projectDetail.startLocation ||
              projectDetail.startLoc ||
              "温州市鹿城区"
            }}</span>
          </div>
        </div>
