 ...
 * @LastEditTime: 2023-01-29 14:20:06
 * @FilePath: \lucheng-app\src\views\appView\waterRegimen\WaterRegimenList.vue
-->
<template>
  <div class="project-wrap">
    ...
    <div class="tap-options">
      <div @click="handerChangeType(item.value)" :class="{'active': typeValue === item.value}" v-for="item in typeOption" :key="item.value">
        {{ item.text }}
      </div>
    </div>
    <div class="select-box">
      <van-dropdown-menu
        ...
        active-color="#276AF0"
      >
        <!-- <van-dropdown-item title-class="title-class-name" v-model="typeValue" :options="typeOption" @change="handerChangeType" /> -->
        <van-dropdown-item
    ...
    <div class="map-box">
      <map-list-shelf>
        ...
        <span>{{ typeValue | type }}数量：{{ list.length }}座</span>
        <template slot="table">
