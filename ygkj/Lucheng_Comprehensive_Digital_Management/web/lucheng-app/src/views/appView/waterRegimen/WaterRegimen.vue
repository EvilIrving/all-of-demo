    ...
    <div class="page-detail-box">
      ...
      <div class="van-grid-box">
        ...
        <div class="van-grid-item">
          ...
          <div class="blue-color">
            <span>{{
              infoData.maxLevelTime ? infoData.maxLevelTime.split(" ")[1] : "-"
            }}</span>
            <span></span>
          </div>
        </div>
      ...
      <div class="echarts-box" v-if="infoData.hasWater || infoData.hasRain">
        ...
        >
          <EchartsBar :extraOption="rainOption" :inverse="infoData.hasWater" :widthIndex="defaultIndex" />
        </div>
    ...
    async getDateList(days) {
      ...
      if (res.code === 0) {
        ...
        res.data.list.forEach((item, index) => {
          ...
          xAxisData.push(`${times[1]}-${times[2]}:00`);
