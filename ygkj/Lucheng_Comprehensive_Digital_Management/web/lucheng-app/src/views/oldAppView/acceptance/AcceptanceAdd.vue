      ...
      <van-cell-group>
        ...
        >
          <template #input>
            ...
            >
              <div v-if="ruleForm.contractFile" class="text-space-overflow">
                {{ contractFileName }}
              </div>
        ...
        >
          <template #input>
            <van-uploader
              ...
              :after-read="afterRead"
            >
              <div v-if="ruleForm.acceptanceFile" class="text-space-overflow">
                {{ acceptanceFileName }}
              </div>
              <div v-else class="gray-color">请上传PDF附件</div>
            </van-uploader>
        ...
        <van-field
          ...
          autosize
        />
        <van-button type="default" :plain="true" @click="goBack"
          >取消</van-button
        >
