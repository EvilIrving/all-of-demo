 ...
 * @LastEditTime: 2022-11-09 15:16:50
 * @FilePath: \lucheng-older\src\views\appView\propertysupervision\archive\Archive.vue
-->
<template>
  <view-page>
          ...
          <div class="card-list" v-for="(item, index) in list" :key="index">
            ...
            <div class="evaluation_box">
              ...
              <div class="evaluation">
                ...
                <span class="state" @click="evaluate(item.id)">{{
                  item.evaluationStatus == 1 ? "评价" : "已评价"
                }}</span>
              </div>
            </div>
          </div>
