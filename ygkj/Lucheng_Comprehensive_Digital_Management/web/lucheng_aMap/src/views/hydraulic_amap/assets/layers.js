export const layersData = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        id: 37,
        label: '海塘道路交叉出入口',
        url: '/projectSide?type=海塘道路交叉出入口',
        type: '交叉建筑物',
        // iconClass: 'icon-catalog-dike',
      },
      {
        id: 38,
        label: '旱闸',
        url: '/projectSide?type=旱闸',
        type: '交叉建筑物',
      },
      {
        id: 39,
        label: '桩号',
        url: '/projectSide?type=桩号',
        type: '交叉建筑物',
      },
      {
        id: 40,
        label: '箱涵',
        url: '/projectSide?type=箱涵',
        type: '交叉建筑物',
      },
      {
        id: 41,
        label: '管理房',
        url: '/projectSide?type=管理房',
        type: '交叉建筑物',
      },
      {
        id: 42,
        label: '测站平台',
        url: '/projectSide?type=测站平台',
        type: '交叉建筑物',
      }
      ,
      {
  ...
  //         id: 'JHXM',
  //         label: "计划项目",
  //         url: "/ProgrammeSide?type=计划项目",
  //         type: '水发展规划'
  //     }, {
  //         id: 'MHXM',
  //         label: "谋划项目",
  //         url: "/ProgrammeSide?type=谋划项目",
  //         type: '水发展规划'
  //     }],
  // }, {
  //     id: 39,
  ...
  //         id: "ZJ_GC",
  //         label: "在建工程",
  //         url: "/InformationOfLakes?type=在建工程",
  //         type: '水灾害防御'
  //     }]
  // },
  // {
  ...
  //         id: "XM",
  //         label: "项目",
  //         url: "/InformationOfLakes?type=项目",
  //         type: '水灾害防御'
  //     }]
  // },
  // {
