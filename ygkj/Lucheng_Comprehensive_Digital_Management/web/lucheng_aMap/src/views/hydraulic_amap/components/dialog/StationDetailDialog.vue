      ...
      <div class="table-box" ref="tableBox">
        <div ref="searchBox">
          <el-row :gutter="20" class="search-panel">           
              ...
              <div class="search-item">
                ...
                <div class="content">
                  ...
                  >
                    ...
                    <el-radio :label="'小(1)型'">小(1)型</el-radio>
                    <el-radio :label="'小(2)型'">小(2)型</el-radio>
                  </el-radio-group>
                </div>
              </div>
            </el-col>
            ...
            <el-col :span="24" class="aa" v-if="stationType == '雨情'">
              <div class="search-item">
...
export default {
  ...
  mounted() {
    this.getAdcdList();
    this.getDetail(this.stationType);
    this.tableHeight = {
      height:
          ...
          if (res.code == 0) {
            if (this.durationRainfall == "") {
              ...
              this.dataList.map(item => {
                item.newest1hour = item.newest1hour ? item.newest1hour.toFixed(2) : item.newest1hour;
              })
              ...
              if (
                ...
                this.dataList.forEach((item, index) => {
                  item["1hour"] = res.data[index]["1hour"] ? res.data[index]["1hour"].toFixed(2) : res.data[index]["1hour"];
                  arr.push(item);
                });
                this.dataList = arr;
              } else if (
                ...
                let arr = [];
                this.dataList.forEach((item, index) => {
                  item["3hour"] = res.data[index]["3hour"] ? res.data[index]["3hour"].toFixed(2) : res.data[index]["3hour"];
                  arr.push(item);
                });
                this.dataList = arr;
              } else if (
                ...
                let arr = [];
                this.dataList.forEach((item, index) => {
                  item["6hour"] = res.data[index]["6hour"] ? res.data[index]["6hour"].toFixed(2) : res.data[index]["6hour"];
                  arr.push(item);
                });
                this.dataList = arr;
              } else if (
                ...
                let arr = [];
                this.dataList.forEach((item, index) => {
                  item["24hour"] = res.data[index]["24hour"] ? res.data[index]["24hour"].toFixed(2) : res.data[index]["24hour"];
                  arr.push(item);
                });
                this.dataList = arr;
              } else if (
                ...
                let arr = [];
                this.dataList.forEach((item, index) => {
                  item["72hour"] = res.data[index]["72hour"] ? res.data[index]["72hour"].toFixed(2) : res.data[index]["72hour"];
                  arr.push(item);
                });
                this.dataList = arr;
              }
