  ...
  methods: {
    ...
    renderDetailInfo() {
      ...
      let activeComponents =
        activeComponentsMap[detailList[this.detailActiveTab].name];
      return (
    ...
    getTyhoonSimilar() {
      hydraulicApi
        .typhoonAnalysis(this.typhoonCode, this.similarType)
        .then((res) => {
