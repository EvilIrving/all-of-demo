...
<template>
  <div class="sidebar-box" v-loading="loading">
    <div
      class="sidebar-progress-box sidebar-progress-box-blue"
...
<style lang="scss">
.sidebar-progress-box.sidebar-progress-box-blue {
  position: relative;
  .el-progress-bar__inner {
    background-image: linear-gradient(270deg, #3dc6ff 0%, #0a65f5 100%);
