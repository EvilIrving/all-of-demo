<template>
  ...
  >
    <div
      :class="['collapse-panel__button', collapse ? 'open' : 'close']"
    ...
    <div ref="wrapper" :style="collapseStyle" :class="['collapse-panel__wrapper']">
      <slot name="slot-panel">
        <div>
          <div class="collapse-panel__border">
...
.collapse-panel {
  ...
  .collapse-panel__button {
    ...
    width: 37px;
    &.open {
      background-image: url(~assets/images/ScreenAsset/collapse-close.png);
      background-repeat: no-repeat;
      background-size: 100% 100%;
    }
    &.close {
      background-image: url(~assets/images/ScreenAsset/collapse-open.png);
      background-repeat: no-repeat;
      background-size: 100% 100%;
    }
  }
  .collapse-panel__wrapper {
    ...
    .collapse-panel__content {
      background: linear-gradient(180deg, rgba(6, 29, 54, 0.6) 0%, rgba(5, 24, 50, 0.7) 100%);
