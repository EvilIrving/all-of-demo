...
import { addAssignedData } from "_a/dataManage/dataSheetManage/dataSheetManage";
    ...
    handleSubmit(name) {
      ...
      this.$refs[name].validate((valid) => {
        if (valid) {
          ...
          // });
          this.form.dataList = this.selectRows;
          //console.log(this.form);
          addAssignedData(this.form).then((res) => {
            if (res.code) {
