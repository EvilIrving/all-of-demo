...
public interface AuthenticationClient {
    ...
    /***************************文件系统api***************************************/
    @GetMapping("/ums/sysFile")
    CommonResult files(@RequestParam(value = "fileIds", required = false) String fileIds);

    /**
     * 档案数据统计
     * @return
     */
    @PostMapping("/ums/sysFile/archivalDataStatistics")
     ...
     * @return
     */
    @PostMapping("/sysAchievement/statisticsTotalArchives")
     ...
     * @return
     */
    @PostMapping("/ums/sysFile/statUploadFile")
    CommonResult statUploadFile(@RequestParam(value = "year", required = false) Integer year);


    /********************************档案收藏服务****************************************/
    @PostMapping("/SysArchiveCollection/insert")
    public CommonResult insertArchiveCollection(SysArchiveCollection entity);

    @PostMapping("/SysArchiveCollection/delete")
    public CommonResult deleteArchiveCollection(@RequestParam(value = "id", required = false)int id);

    @PostMapping("/SysArchiveCollection/update")
    public CommonResult updateArchiveCollection(SysArchiveCollection entity);

    @PostMapping("/SysArchiveCollection/findById")
    public CommonResult findArchiveCollectionById(@RequestParam(value = "id", required = false)int id);

    @PostMapping("/SysArchiveCollection/pageList")
    public PageVO<SysArchiveCollection> pageArchiveCollectionList(@RequestBody SysArchiveCollectionReqVO vo);

    @GetMapping("sys/archiveDept")
    CommonResult archiveDept(@RequestParam(value = "deptIds", required = false) String deptIds);
}
