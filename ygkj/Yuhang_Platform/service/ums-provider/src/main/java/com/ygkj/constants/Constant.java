...
public class Constant {
    ...
    public static final String JWT_DING_USER="jwt-ding-user";

    public static final String JWT_DING_DEPT_ID="jwt-ding-dept-id";
    public static final String JWT_DING_DEPT_NAME="jwt-ding-dept-name";
    /**
     * 角色key
     */
