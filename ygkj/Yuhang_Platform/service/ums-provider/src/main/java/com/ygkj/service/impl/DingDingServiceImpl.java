...
public class DingDingServiceImpl implements DingDingService {
    ...
    @Value("${watermanage.syn.tokenkey}")
    private String KEY_TOKEN;
    @Value("${watermanage.syn.appkey}")
    private String APP_KEY;
    @Value("${watermanage.syn.appsecret}")
    private String APP_SECRET;
    @Value("${watermanage.syn.data_tokenkey}")
    private String DATA_KEY_TOKEN;
    @Value("${watermanage.syn.data_appkey}")
    private String DATA_APP_KEY;
    @Value("${watermanage.syn.data_appsecret}")
    private String DATA_APP_SECRET;
    private static final Long KEY_EXPIRE = 60 * 30L;
