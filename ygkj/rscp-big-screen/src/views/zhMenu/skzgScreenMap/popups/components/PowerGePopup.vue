<!--
 * @Author: hanyu
 * @LastEditTime: 2022-10-25 10:11:04
 * @Description: 发电 弹窗 
 * @FilePath: \rscp-big-screen\src\views\skzgScreen\skzgScreenMap\popups\components\PowerGePopup.vue
-->
<template>
  <div class="popup_map">
    ...
    <div class="dialog_body">
      <div class="body_content">
        ...
        <div class="left_item">
          <p>水库库容(万m³)：</p>
          <span>{{popupData.TATOL_STORAGE?popupData.TATOL_STORAGE:"-"}}</span>
        </div>
        <!-- <div class="left_item bg">
          <p>当前供水量：</p>
          <span>{{popupData.supply_total?popupData.supply_total:"-"}}</span>
        </div> -->
        <div class="left_item bg">
          <p>当前发电量(万千瓦时)：</p>
          <span>{{popupData.generating_capacity}}</span>
        </div>
      </div>
    </div>
  </div>
