 ...
 * @Description: 
 * @LastEditors: dtb
 * @LastEditTime: 2022-10-18 14:56:51
 * @FilePath: \rscp-big-screen\src\views\IntelligenceScreen\seawall\components\ProjectPopup.vue
-->
<template>
  <div class="">
      ...
      <div class="proj_top">
        ...
        <div class="proj_left">
          ...
          <div class="proj_detail">
            ...
            <!-- <div class="popup_item">
              <p>跨界形式：</p>
              <span>{{ pointData.dts ? pointData.dts : "-" }}</span>
            </div> -->
...
export default {
  ...
  methods: {
    ...
    // 弹窗内打开查看工程详情
    lookDetail(row) {
      this.$parent.$parent.openDetailPopup(row.prcd, row.name);
    },
