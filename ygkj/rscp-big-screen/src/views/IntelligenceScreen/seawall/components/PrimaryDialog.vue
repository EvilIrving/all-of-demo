<template>
  <el-dialog :top="top" :visible="visible" :width="width" :before-close="handleClose" :modal="modal" :append-to-body="appendToBody" full-screen :fullscreen="fullscreen" :close-on-click-modal="false" class="primary-dialog-ht whitestyle">
