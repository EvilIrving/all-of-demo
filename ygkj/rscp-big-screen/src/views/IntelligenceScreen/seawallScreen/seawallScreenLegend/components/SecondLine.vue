 ...
 * @Description: 非一线海塘
 * @LastEditors: dtb
 * @LastEditTime: 2023-01-06 11:17:21
 * @FilePath: \rscp-big-screen\src\views\IntelligenceScreen\seawallScreen\seawallScreenLegend\components\SecondLine.vue
-->
  ...
  methods: {
    async getSeawallList() {
      ...
      if (res.success) {
        ...
        this.$parent.$parent.$refs.seawallMap._drawLines(lineArr, "seawallPopup");
      }
    },
