 ...
 * @Description: 
 * @LastEditors: dtb
 * @LastEditTime: 2022-04-20 15:42:45
 * @FilePath: \rscp-big-screen\src\views\skzgScreen\skzgScreenLegend\components\WaterAvailabilityScale.vue
-->
<template>
  <div class='wrap'>
...
export default {
  ...
  methods: {
    ...
    async getMapOverlay() {
      ...
      this.$parent.$parent.$refs.skzgMap.getMapWaterAvailabilityData(opt, this.apiOnce = false)
    },
  }
}
</script>
