 ...
 * @Description: 纳蓄图例
 * @LastEditors: dtb
 * @LastEditTime: 2022-04-08 18:32:43
 * @FilePath: \rscp-big-screen\src\views\skzgScreen\skzgScreenLegend\components\XsQuantityScale.vue
-->
<template>
  <div class='wrap'>
...
export default {
  ...
  methods: {
    changeScale(value) {
      ...
      this.$store.commit('SET_WATER_STORAGE_QUANTITY', tempArr.join(','))
      this.getMapOverlay()
    },
    async getMapOverlay() {
      ...
      this.$parent.$parent.$refs.skzgMap.getMapFloowData(1, opt, this.apiOnce = false) // 1:蓄水量
    },
  }
}
</script>
