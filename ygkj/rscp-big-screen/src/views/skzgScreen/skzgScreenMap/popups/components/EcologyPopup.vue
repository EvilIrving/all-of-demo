<!--
 * @Author: hanyu
 * @LastEditTime: 2022-10-25 10:10:21
 * @Description: 生态 弹窗 
 * @FilePath: \rscp-big-screen\src\views\skzgScreen\skzgScreenMap\popups\components\EcologyPopup.vue
-->
<template>
  <div class="popup_map">
    ...
    <div class="dialog_body">
      <div class="body_content">
        ...
        <div class="left_item bg">
          <p>当前状态：</p>
          <span>{{popupData.water_status == 1 ?'放水':'未放水'}}</span>
        </div>
        <div class="left_item">
          <p>是否是水利风景区：</p>
          <span>{{popupData.scenic == 1 ?'是':'否'}}</span>
        </div>
      </div>
    </div>
  </div>
