<!--
 * @Author: hanyu
 * @LastEditTime: 2022-10-15 10:45:31
 * @Description: 地图右侧-潮位预警
 * @FilePath: \rscp-big-screen\src\views\rscpDriveScreen\seawall\seawallRight\SeawallRightCwyj.vue
-->
<template>
  <div class='wrap'>
  ...
  methods: {
    ...
    async updateValue() {
      ...
      if (res.success) {
        ...
        this.$emit('update.rightSelectList2', rightSelectList2)
      }
    }
  }
}
