<!--
 * @Author: hanyu
 * @LastEditTime: 2022-08-01 17:36:05
 * @Description: 
 * @FilePath: \rscp-big-screen\src\views\rscpDriveScreen\seawall\SeawallScreen.vue
-->
<template>
  <div class='screen_wrap'>
    ...
    <section class="drawer_right" :class="{showRight: drawerShowRight}">
      ...
      <img class="_open" v-if="!isShowHideLayer" src="../../../assets/images/right_select.png" @click="showHideLayer()">
...
import SeawallRightTflj from './seawallRight/SeawallRightTflj'
import SeawallRightPhoto from './seawallRight/SeawallRightPhoto'
...
export default {
  ...
  components: {
    SeawallMap, SeawallLeft, SeawallRightDefault, SeawallRightCwyj, SeawallRightSscw, SeawallRightAljs, SeawallRightTflj, SeawallRightPhoto, SeawallRightVideo, PreviewPhoto, PreviewVideo, PreviewBrief
  },
  computed: {
    seawallSelectFlag(){
...
<style lang="scss" scoped>
  ...
  .right_select_title{
    ...
    font-size: 14px;
    line-height: 16px;
    background: -webkit-linear-gradient(90deg, #E4F3FC 13%, rgba(201,219,250,0.00) 98%);
    background: -o-linear-gradient(90deg, #E4F3FC 13%, rgba(201,219,250,0.00) 98%);
    background: -moz-linear-gradient(90deg, #E4F3FC 13%, rgba(201,219,250,0.00) 98%);
    background: linear-gradient(90deg, #E4F3FC 13%, rgba(201,219,250,0.00) 98%);
    img{
      margin-right: 8px;
    }
  }
