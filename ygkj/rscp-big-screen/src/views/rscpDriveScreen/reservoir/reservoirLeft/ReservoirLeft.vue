<!--
 * @Author: hanyu
 * @LastEditTime: 2022-01-12 15:07:57
 * @Description: 地图左侧-统计
 * @FilePath: \rscp-big-screen\src\views\rscpDriveScreen\reservoir\reservoirLeft\ReservoirLeft.vue
-->
<template>
  <div class="map_left">
    ...
    <!-- <pie-chart v-loading="skgmLoading" :style="{ height: barHeight }" class="skLeftChart" :chartData="skgmData" @pieClick="pieClick2"></pie-chart> -->
