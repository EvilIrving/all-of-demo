<!--
 * @Author: hanyu
 * @LastEditTime: 2022-05-24 09:30:28
 * @Description: 
 * @FilePath: /rscp-big-screen/src/views/rscpDriveScreen/reservoir/ReservoirScreen.vue
-->
<template>
...
import ReservoirLeft from "./reservoirLeft/ReservoirLeft";
import ReservoirRightDefault from "./reservoirRight/ReservoirRightDefault";
import ReservoirRightCwyj from "./reservoirRight/ReservoirRightCwyj";
import ReservoirRightSscw from "./reservoirRight/ReservoirRightSscw";
import ReservoirRightBxsk from "./reservoirRight/ReservoirRightBxsk";
import ReservoirRightSthe from "./reservoirRight/ReservoirRightSthe.vue";
import ReservoirRightTwo from "./reservoirRight/ReservoirRightTwo";
import ReservoirRightOne from "./reservoirRight/ReservoirRightOne";
import ReservoirRightAll from "./reservoirRight/ReservoirRightAll";
import ReservoirRightXsl from "./reservoirRight/ReservoirRightXsl";
import ReservoirRightKgkn from "./reservoirRight/ReservoirRightKgkn";
import ReservoirRightNxnl from "./reservoirRight/ReservoirRightNxnl";
import ReservoirRightTflj from "./reservoirRight/ReservoirRightTflj";
import ReservoirRightPhoto from "./reservoirRight/ReservoirRightPhoto";
import ReservoirRightVideo from "./reservoirRight/ReservoirRightVideo";
