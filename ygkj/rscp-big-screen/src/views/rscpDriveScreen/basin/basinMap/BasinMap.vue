<!--
 * @Author: hanyu
 * @LastEditTime: 2022-10-11 11:19:57
 * @Description: 
 * @FilePath: \rscp-big-screen\src\views\rscpDriveScreen\basin\basinMap\BasinMap.vue
-->
<template>
  <div class="map_wrap">
    ...
    mapInit() {
      ...
      this.map = new Map({
        ...
        layers: [
          ...
          new Tile({
            source: new XYZ({
              url: "https://sldtpt.zjwater.com:6443/zjsslgcyxglpt/PBS/rest/services/ZLSLVectorMap/MapServer/tile/{z}/{y}/{x}",
              projection: "EPSG:4326",
              crossOrigin: "anonymous",
            }),
            preload: 1,
