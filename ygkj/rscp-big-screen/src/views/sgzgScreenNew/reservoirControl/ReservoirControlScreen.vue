<!--
 * @Author: hanyu
 * @LastEditTime: 2021-12-26 19:45:19
 * @Description: 
 * @FilePath: /rscp-big-screen/src/views/sgzgScreenNew/reservoirControl/ReservoirControlScreen.vue
-->
<template>
...
// import ScreenLeft from "./reservoirControlLeft/ReservoirControlLeft";
import ScreenLeft from "./reservoirControlLeft/ReservoirControlLeftNew";
import ScreenRight from "./reservoirControlRight/ReservoirControlRight";
