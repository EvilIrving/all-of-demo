<!--
 * @Author: hanyu
 * @LastEditTime: 2021-12-25 12:01:23
 * @Description: 
 * @FilePath: /rscp-big-screen/src/views/sgzgScreenNew/zhekuHousehold/ZhekuHouseholdScreen.vue
-->
<template>
...
import ScreenLeft from "./zhekuHouseholdLeft/ZhekuHouseholdLeft";
import ScreenRight from "./zhekuHouseholdRight/ZhekuHouseholdRight";
...
export default {
  ...
  mounted() {
    // http://192.168.2.72:8080/screen?isSgzg=1&hasTop=1&type=zhekuHousehold
