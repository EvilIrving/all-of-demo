 ...
 * @Description: 
 * @LastEditors: dtb
 * @LastEditTime: 2021-12-26 18:28:23
 * @FilePath: \rscp-big-screen\src\views\sgzgScreenNew\reservoirBenefit\reservoirBenefitRight\ReservoirBenefitRight.vue
-->
<template>
  <div class="wrap">
    ...
    <section class="xsl_box">
      ...
      <div class="benefit_box">
        <ul class="date_box">
          ...
          <li>
            <p>水量<i>(万m³)</i></p>
            <div class="blue_text">755,900</div>
          </li>
    ...
    <section class="xsl_box">
      ...
      <div class="benefit_box">
        <ul class="date_box">
          ...
          <li>
            <p>水量<i>(万m³)</i></p>
            <div class="blue_text">570,375 </div>
          </li>
