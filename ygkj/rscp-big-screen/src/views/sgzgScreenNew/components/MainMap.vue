<!--
 * @Author: hanyu
 * @LastEditTime: 2022-10-11 11:20:21
 * @Description: 
 * @FilePath: \rscp-big-screen\src\views\sgzgScreenNew\components\MainMap.vue
-->
<template>
  <div class="map_wrap">
    ...
    <div class="popup_map" ref="popup" v-show="currentCoordinate">
      ...
      <!-- 病险水库 -->
      <div class="popup_content" v-show="popupData.rightType == '2' && !popupData.hoverType">
      ...
      <!-- 纳蓄能力 -->
      <div class="popup_content" v-show="popupData.rightType == '3' && !popupData.hoverType">
        <div class="popup_title" style="color: #003ec7; cursor: pointer" @click="lookDetail(popupData)">
          {{ popupData.NAME }}
        </div>
        <div class="popup_item">
      ...
      <!-- 实时预警 -->
      <div class="popup_content" v-show="popupData.rightType == '8' && !popupData.hoverType">
        <div class="popup_title" style="color: #003ec7; cursor: pointer" @click="lookDetail(popupData)">
          {{ popupData.NAME }}
        </div>
        <div class="popup_item">
      ...
      <!-- 预测预警 -->
      <div class="popup_content" v-show="popupData.rightType == '5' && !popupData.hoverType">
        <div class="popup_title" style="color: #003ec7; cursor: pointer" @click="lookDetail(popupData)">
          {{ popupData.NAME }}
        </div>
        <div class="popup_item">
        ...
        layers: [
          ...
          new Tile({
            source: new XYZ({
              ...
              url: "https://sk.zjwater.com/ygMpServer/arcgis/rest/services/basemap/ZLSLVectorMap/MapServer/tile/{z}/{y}/{x}",
              projection: "EPSG:4326", //使用这个坐标系
              // crossOrigin: "anonymous",
            }),
            preload: 1,
