<!--
 * @Date: 2021-12-24 09:31:34
 * @Author: dtb
 * @Description: 
 * @LastEditors: dtb
 * @LastEditTime: 2021-12-25 17:55:12
 * @FilePath: \rscp-big-screen\src\views\sgzgScreenNew\reservoirStorage\ReservoirStorageScreen.vue
-->
...
import ReservoirStorageLeft from "./reservoirStorageLeft/ReservoirStorageLeft.vue";
import ReservoirStorageRight from "./reservoirStorageRight/ReservoirStorageRight.vue";
...
export default {
  ...
  components: {
    MainMap,
    ReservoirStorageLeft,
    ReservoirStorageRight,
    PreviewPhoto,
    PreviewVideo,
    PreviewCamera,
  },
  ...
  methods: {
    ...
    // 画点 聚合
    getMapFloowData(pointArr, type) {
      this.$nextTick(() => {
        this.$refs.reservoirStorageMap.getMapFloowData();
      });
    },
    // 画点 不聚合
