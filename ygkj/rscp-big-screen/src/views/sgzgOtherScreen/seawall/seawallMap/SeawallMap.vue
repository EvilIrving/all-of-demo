  ...
  <div class='map_wrap'>
    ...
    <div class="popup_map" ref="popup" v-show="currentCoordinate">
      ...
      <div class="proj_content" v-show="popupData.rightType == '4'">
        <div class="proj_left_border"></div>
        <div class="proj_top_border"></div>
        <div class="proj_right_border"></div>
        <div class="proj_bottom_border"></div>
    ...
    mapInit() {
      ...
      this.map = new Map({
        ...
        layers: [
          ...
          //     url:
          //       "https://sldtpt.zjwater.com:6443/zjsslgcyxglpt/arcgis/rest/services/basemap/WYX1029/MapServer/tile/{z}/{y}/{x}", //白色
          //     projection: "EPSG:4326" //使用这个坐标系
          //     // crossOrigin: "anonymous",
          //   }),
          //   preload: 1,
        ...
        success: function(res) {
          if (res.length) {
            ...
            for (let i = 0; i < res.length; i++) {
              jquery.ajax({
                url:
                  "http://typhoon.zjwater.gov.cn/Api/TyphoonInfo/" +
                  res[0].tfid,
                type: "get",
                dataType: "jsonp",
                data: {},
  ...
  .popup_map {
    ...
    .proj_content {
      ...
      .proj_left_border {
        ...
        bottom: 8px;
        width: 9px;
        background-image: url("~@/assets/images/popup-border-left-iamge.png");
      }
      .proj_top_border {
        position: absolute;
        left: 9px;
        ...
        top: 0;
        height: 8px;
        background-image: url("~@/assets/images/popup-border-top-iamge.png");
      }
      .proj_right_border {
        position: absolute;
        top: 0;
        ...
        bottom: 8px;
        width: 9px;
        background-image: url("~@/assets/images/popup-border-right-iamge.png");
      }
      .proj_bottom_border {
        position: absolute;
        left: 9px;
        ...
        bottom: 0;
        height: 8px;
        background-image: url("~@/assets/images/popup-border-bottom-iamge.png");
      }
      .carousel_box {
        height: 160px;
        .carousel_item {
      ...
      .proj_title {
        ...
        font-family: "youshe";
        line-height: 31px;
        border-bottom: 2px solid rgba(51, 144, 225, 0.98);
        margin-bottom: 16px;
        z-index: 0;
        &::before {
          content: "";
        ...
        &::after {
          ...
          display: block;
          height: 12px;
          background: rgba(51, 144, 225, 0.14);
          z-index: -1;
        }
      }
      .baseInfo_title {
