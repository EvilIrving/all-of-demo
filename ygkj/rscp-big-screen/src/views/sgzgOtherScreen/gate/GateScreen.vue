<!--
 * @Author: hanyu
 * @LastEditTime: 2022-11-29 09:40:45
 * @Description: 
 * @FilePath: \rscp-big-screen\src\views\sgzgOtherScreen\gate\GateScreen.vue
-->
<template>
  <div class="screen_wrap">
    ...
    <basin-map ref="mainMap" title='智慧闸站'></basin-map>
    <section class="drawer_right" :class="{ showRight: drawerShowRight }">
      <!-- <keep-alive> -->
      <gate-right :safeStatus="safeStatus"></gate-right>
      <!-- </keep-alive> -->
  <!-- 临时隐藏tabs栏  展示第一个 -->
      <!-- <img
...
import GateLeft from "./gateLeft/GateLeft";
import GateRight from "./gateRight/GateRight";
...
export default {
  ...
  methods: {
    ...
    async getRightSelectList() {
      ...
      let res = await gateStatisticApi(this.opt);
      if (res.success){
