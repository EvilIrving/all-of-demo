<!--
 * @Author: hanyu
 * @LastEditTime: 2021-10-21 10:27:40
 * @Description: 流域大屏右侧-泵站
 * @FilePath: /rscp-big-screen/src/views/bigScreen/basin/basinRight/BasinRightPump.vue
-->
<template>
  <div class="wrap">
    ...
    <section class="reservoirList_box">
      ...
      <div class="table_list" ref="tableContainer">
        ...
        >
          ...
          <el-table-column prop="NAME" label="泵站名称"></el-table-column>
    ...
    async getReservoirList(colorNum) {
      if (this.listFlag) {
        ...
        if (res.success) {
          ...
          this.$parent.showMapPoints(pointArr, 'pump');
        }
        this.listFlag = true;
