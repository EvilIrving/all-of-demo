...
<!--    <div class="chart_line"></div>-->
    <section class="adcd_box" :style="{ height: barHeight }">
      ...
      <basin-single-bar-chart v-loading="adcdChartLoading"
                              class="leftChart" :chartData="adcdChartData" @barClick="adcdChartClick"
                              element-loading-background="rgba(0, 0, 0, 0.1)"></basin-single-bar-chart>
    </section>
<!--    <div class="chart_line"></div>-->
    <section class="type_box" :style="{ height: barHeight }">
      ...
      <basin-single-bar-chart v-loading="scaleLoading" class="leftChart" :chartData="scaleData" @barClick="scaleChartClick" element-loading-background="rgba(0, 0, 0, 0.1)"></basin-single-bar-chart>
    </section>
  </div>
</template>
