<!--
 * @Author: hanyu
 * @LastEditTime: 2021-12-03 11:38:28
 * @Description: 单一数据柱状图
 * @FilePath: /rscp-big-screen/src/views/bigScreen/sluice/components/BasinSingleBarChart.vue
-->
     ...
     // console.log(this.chartData)
      ...
      let option = {
        ...
        grid: {
          ...
          left: "12",
          right: "8",
          bottom: this.chartData.xShupai ? "48" : "33",
          containLabel: true
        },
        xAxis: {
