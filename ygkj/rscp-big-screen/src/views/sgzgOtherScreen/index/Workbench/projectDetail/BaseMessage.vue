<!--
 * @Author: hanyu
 * @LastEditTime: 2022-10-11 11:20:08
 * @Description: 工作台-基础信息
 * @FilePath: \rscp-big-screen\src\views\sgzgOtherScreen\index\Workbench\projectDetail\BaseMessage.vue
-->
<template>
  <div class="wrap">
      ...
      <div class="proj_top">
        ...
        <div class="proj_left">
          ...
          <div class="proj_title" @click="lookDetail(popupData)">
            <img
              class="title_img"
              v-if="!popupData.status || popupData.status == '一类坝'"
              :src="$config.imgUrl+ 'status-green.png'"
              alt=""
            />
            <img
              class="title_img"
              v-if="popupData.status && popupData.status == '二类坝'"
              :src="$config.imgUrl+ 'status-yellow.png'"
              alt=""
            />
            <img
              class="title_img"
              ...
              "
              :src="$config.imgUrl+ 'status-red.png'"
              alt=""
            />
            <!-- <p>行政区划：</p> -->
            <span>{{ popupData.NAME ? popupData.NAME : '-'}}</span>
            <span
              v-if="popupData.project_scale == '1'"
              v-html="'&nbsp[大(1)型]'"
            ></span>
            <span
              v-if="popupData.project_scale == '2'"
              v-html="'&nbsp[大(2)型]'"
            ></span>
            <span
              v-if="popupData.project_scale == '3'"
              v-html="'&nbsp[中型]'"
            ></span>
            <span
              v-if="popupData.project_scale == '4'"
              v-html="'&nbsp [小(1)型]'"
            ></span>
            <span
              v-if="popupData.project_scale == '5'"
              v-html="'&nbsp [小(2)型]'"
            ></span>
          </div>
          <div class="proj_detail">
            ...
            <div
              class="popup_item"
              v-if="popupData.rightPopType && popupData.rightPopType == 'kgkn'"
            >
              <p>可纳雨：</p>
              <span>{{
