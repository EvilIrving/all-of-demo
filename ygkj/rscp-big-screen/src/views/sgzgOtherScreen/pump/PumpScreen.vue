<!--
 * @Author: hanyu
 * @LastEditTime: 2022-11-29 09:40:09
 * @Description: 
 * @FilePath: \rscp-big-screen\src\views\sgzgOtherScreen\pump\PumpScreen.vue
-->
<template>
  <div class="screen_wrap">
    ...
    <basin-map ref="mainMap" title='智慧泵站'></basin-map>
    <section class="drawer_right" :class="{ showRight: drawerShowRight }">
      <!-- <keep-alive> -->
      <pump-right :safeStatus="safeStatus"></pump-right>
      <!-- </keep-alive> -->
...
import PumpLeft from "./pumpLeft/PumpLeft";
import PumpRight from "./pumpRight/PumpRight";
...
export default {
  ...
  methods: {
    ...
    async getRightSelectList() {
      ...
      let res = await pumpStatisticApi(this.opt);
      if (res.success){
