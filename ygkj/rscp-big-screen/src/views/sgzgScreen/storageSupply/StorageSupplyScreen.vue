<!--
 * @Author: hanyu
 * @LastEditTime: 2021-12-16 13:56:10
 * @Description: 
 * @FilePath: /rscp-big-screen/src/views/sgzgScreen/storageSupply/StorageSupplyScreen.vue
-->
<template>
  <div class="screen_wrap">
    ...
    <section class="drawer_right" :class="{ showRight: drawerShowRight }">
      <reservoir-right-kgkn></reservoir-right-kgkn>
      <img
...
<script>
import ReservoirMap from "./storageSupplyMap/StorageSupplyMap";
import ReservoirLeft from "./storageSupplyLeft/StorageSupplyLeft";
import ReservoirRightKgkn from "./storageSupplyRight/StorageSupplyRightKgkn";
