<!--
 * @Author: hanyu
 * @LastEditTime: 2022-09-08 09:34:54
 * @Description: 地图右侧-工程视频
 * @FilePath: \rscp-big-screen\src\views\sgzgScreen\tideAnalysis\tideAnalysisRight\SeawallRightVideo.vue
-->
<template>
  <div class='wrap'>
    <progress-list v-loading="progressLoading" title="工程视频分布情况" class="progress" :progressData="progressData"></progress-list>
...
<script>
import { seawallLeftStatisticApi, videoListApi, videoSelectApi, getVideoUrlApi } from '@/api/api_seawall'
