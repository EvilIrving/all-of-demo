<!--
 * @Author: hanyu
 * @LastEditTime: 2022-10-11 11:20:15
 * @Description: 
 * @FilePath: \rscp-big-screen\src\views\sgzgScreen\intelligenceUse\intelligenceUseMap\IntelligenceUseMap.vue
-->
<template>
  <div class="map_wrap">
      ...
      for (var i = 0; i < pointData.length; i++) {
        ...
        jquery("#overly").after(
          `<div id = 'overly"+i+"' class='overlay'>"
            <div class="popup_content">
              <div class="popup_title">${pointData[i].coastalName} </div>
              <div class="popup_item">
                <p>预报潮位：</p>
                <span>${
                  pointData[i].forecast ? pointData[i].forecast : "-"
                }</span>
              </div>
              <div class="popup_item">
                <p>时间：</p>
                <span>${
                  pointData[i].forecastTime ? pointData[i].forecastTime : "-"
                }</span>
              </div>
            </div>
          </div>`
