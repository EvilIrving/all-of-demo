<!--
 * @Author: hanyu
 * @LastEditTime: 2021-12-17 15:55:02
 * @Description: 流域大屏右侧-堤防
 * @FilePath: /rscp-big-screen/src/views/sgzgScreen/intelligenceUse/intelligenceUseRight/DikeRight.vue
-->
<template>
  <div class="wrap">
    ...
    <section class="reservoirList_box">
      ...
      <div class="table_list" :style="{height: safeStatus == 'firstCnt' || safeStatus == 'totalCnt' ? 'calc(100% - 240px)' : 'calc(100% - 170px)'}" ref="tableContainer">
        <el-table
          :height="tableHeight"
