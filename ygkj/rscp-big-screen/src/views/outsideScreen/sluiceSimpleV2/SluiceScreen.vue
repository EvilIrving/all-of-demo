<!--
 * @Author: hanyu
 * @LastEditTime: 2022-07-11 16:23:38
 * @Description: 
 * @FilePath: \rscp-big-screen\src\views\outsideScreen\sluiceSimpleV2\SluiceScreen.vue
-->
<template>
  <div class="screen_wrap">
    ...
    <basin-map ref="mainMap" title='水闸工程研判'></basin-map>
