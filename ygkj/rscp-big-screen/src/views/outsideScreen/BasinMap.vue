<!--
 * @Date: 2022-07-11 15:42:27
 * @Author: 
 * @Description: SimpleV2版本dike gate sluice pump白色底图
 * @LastEditors: dtb
 * @LastEditTime: 2022-10-11 11:19:42
 * @FilePath: \rscp-big-screen\src\views\outsideScreen\BasinMap.vue
-->
<template>
  <div class="map_wrap">
