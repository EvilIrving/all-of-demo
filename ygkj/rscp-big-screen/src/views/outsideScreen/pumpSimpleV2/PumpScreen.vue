<!--
 * @Author: hanyu
 * @LastEditTime: 2022-07-11 16:27:31
 * @Description: 
 * @FilePath: \rscp-big-screen\src\views\outsideScreen\pumpSimpleV2\PumpScreen.vue
-->
<template>
  <div class="screen_wrap">
    ...
    <basin-map ref="mainMap" title='泵站工程研判'></basin-map>
