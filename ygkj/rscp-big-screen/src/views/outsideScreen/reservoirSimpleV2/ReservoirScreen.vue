 ...
 * @Description: 
 * @FilePath: /rscp-big-screen/src/views/outsideScreen/reservoirSimpleV2/ReservoirScreen.vue
-->
<template>
  <div class="screen_wrap">
    <section class="drawer_left" v-if="timeShowRight && whiteLeft == 1" :class="{ showLeft: drawerShowLeft }">
    ...
    <section class="drawer_right" v-if="timeShowRight" :class="{ showRight: drawerShowRight }">
      <!-- <keep-alive> -->
      <!-- 三类坝 -->
      ...
      <!-- <reservoir-right-photo ref="reservoirRightPhoto" v-if="rightIndex === 2"></reservoir-right-photo> -->
      <!-- <reservoir-right-tflj v-if="rightIndex === 3"></reservoir-right-tflj> -->
      <!-- <reservoir-right-nxnl v-if="rightIndex === 5"></reservoir-right-nxnl> -->
      <!-- <reservoir-right-sscw v-if="rightIndex === 4"></reservoir-right-sscw> -->
      <reservoir-right-xsl v-if="rightIndex === 5"></reservoir-right-xsl>
      <reservoir-right-kgkn v-if="rightIndex === 6"></reservoir-right-kgkn>
      <!-- 临时隐藏 实时预警 -->
      <!-- <reservoir-right-sscw v-if="rightIndex === 6"></reservoir-right-sscw> -->
      <reservoir-right-cwyj
        v-if="rightIndex ===7"
        @openMassageDialog="openMassageDialog"
      ...
      >
        ...
        <!-- <div
          class="right_select_item"
          :class="idx + 4 === rightIndex ? 'active' : ''"
          v-for="(ite, idx) in rightSelectList2"
          :key="ite.name"
          @click="rightSelectClick(idx + 4)"
        >
          <p>{{ ite.name }}</p>
          <span>
            <span>
...
import ReservoirLeft from "../../rscpDriveScreen/reservoir/reservoirLeft/ReservoirLeft";
import ReservoirRightCwyj from "../../rscpDriveScreen/reservoir/reservoirRight/ReservoirRightCwyj";
import ReservoirRightBxsk from "../../rscpDriveScreen/reservoir/reservoirRight/ReservoirRightBxsk.vue";
import ReservoirRightTwo from "../../rscpDriveScreen/reservoir/reservoirRight/ReservoirRightTwo.vue";
import ReservoirRightOne from "../../rscpDriveScreen/reservoir/reservoirRight/ReservoirRightOne.vue";
import ReservoirRightAll from "../../rscpDriveScreen/reservoir/reservoirRight/ReservoirRightAll.vue";
import ReservoirRightSthe from "../../rscpDriveScreen/reservoir/reservoirRight/ReservoirRightSthe.vue";
...
import ReservoirRightPhoto from "../../rscpDriveScreen/reservoir/reservoirRight/ReservoirRightPhoto";
import ReservoirRightVideo from "../../rscpDriveScreen/reservoir/reservoirRight/ReservoirRightVideo";
...
export default {
  ...
  mounted() {
    this.whiteLeft = getQueryString('whiteLeft')
    setTimeout(()=>{
      this.timeShowRight = true
    },1000)
