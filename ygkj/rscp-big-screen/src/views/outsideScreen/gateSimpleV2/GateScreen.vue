<!--
 * @Author: hanyu
 * @LastEditTime: 2022-07-11 15:48:40
 * @Description: 
 * @FilePath: \rscp-big-screen\src\views\outsideScreen\gateSimpleV2\GateScreen.vue
-->
<template>
  <div class="screen_wrap">
    ...
    <basin-map ref="mainMap" title='闸站工程研判'></basin-map>
