<!--
 * @Author: hanyu
 * @LastEditTime: 2021-08-19 11:35:59
 * @Description: 
 * @FilePath: /rscp-big-screen/src/views/bigScreen/reservoirSimple/ReservoirScreen.vue
-->
<template>
  <div class='screen_wrap'>
    <reservoir-map ref="reservoirMap"></reservoir-map>
    <section class="drawer_right_qtj" :class="{showRightQtj: drawerShowRight}">
      <!-- 三类坝 -->
      <reservoir-right-bxsk></reservoir-right-bxsk>
      <div class="drawer_right_btn" v-show="drawerShowRight" @click="close('Right')">
        <i class="el-icon-caret-right" style="color:#5782ef"></i>
      </div>
      <div class="drawer_right_btn" v-show="!drawerShowRight" @click="open('Right')">
...
export default {
  ...
  components: {
    ReservoirMap, ReservoirRightBxsk, PreviewPhoto, PreviewVideo, PreviewCamera, PreviewBrief
  },
  computed: {
