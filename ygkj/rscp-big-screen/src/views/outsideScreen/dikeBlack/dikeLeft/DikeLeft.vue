<!--
 * @Author: hanyu
 * @LastEditTime: 2022-07-11 15:33:18
 * @Description: 地图左侧-统计
 * @FilePath: \rscp-big-screen\src\views\outsideScreen\dikeBlack\dikeLeft\DikeLeft.vue
-->
<template>
  <div class="map_left">
      ...
      <div class="basin_list" v-loading="basinLoading">
        <div :class="['basin_item', basinIndex === index ? 'active' : '']" v-for="(item, index) in basinList" :key="index" @click="clickBasin(index)">
          <div class="basin_item_left">
            <img v-if="basinIndex === index" src="@/assets/images/basin1.png" alt="">  如果需要恢复取消此注释，需要单独注释此行
            <img src="@/assets/images/basin0.png" alt="">
            <p>{{item.basinName}}</p>
          </div>
