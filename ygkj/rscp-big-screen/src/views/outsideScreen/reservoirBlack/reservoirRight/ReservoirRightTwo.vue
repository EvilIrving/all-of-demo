<!--
 * @Author: hanyu
 * @LastEditTime: 2022-04-21 15:41:38
 * @Description: 地图右侧-病险水库
 * @FilePath: /rscp-big-screen/src/views/outsideScreen/reservoirBlack/reservoirRight/ReservoirRightTwo.vue
-->
<template>
  <div class="wrap">
          ...
          if (res.data.length) {
            ...
            res.data.map((v) => {
              ...
              if (this.squareIndex === "") {
                ...
                v.waterLevel !== null && v.NWL !== null && v.waterLevel > v.NWL
                  ? (v.colorType = "orange")
                  : "";
              }
              if (v.colorType) {
