<!--
 * @Author: hanyu
 * @LastEditTime: 2022-04-21 15:41:21
 * @Description: 三类坝
 * @FilePath: /rscp-big-screen/src/views/outsideScreen/reservoirBlack/reservoirRight/ReservoirRightBxsk.vue
-->
<template>
  <div class="wrap">
          ...
          if (res.data.length) {
            ...
            res.data.map((v) => {
              ...
              if (this.squareIndex === "") {
                ...
                //   v.colorType = "blue";
                // } else if (v.DDZ + 1 < v.waterLevel && v.waterLevel < v.WTELE) {
                //   v.colorType = "yellow";
                // } else if (v.waterLevel > v.WTELE) {
                //   v.colorType = "orange";
                // }
                v.waterLevel !== null &&
