...
export default {
  ...
  computed: {
    ...
    systemType() {
      ...
      // }
      return this.$microStore.state.systemType;
    }
  },
  watch: {
    systemType(val) {
  ...
  methods: {
    ...
    getSceneList() {
      ...
      console.log(this.SceneList, 888)
        ...
        sceneList.push(
          (
            ...
            >
              ...
              {this.SceneList[i].editable ? renderDelBtn(i) : null}
            </li>
          )
        )
      }
...
.action-popover {
  ...
  border-radius: 4px;
  background: rgba(0, 0, 0, 0) url(~assets/images/custom_card/popover-bg.png)
