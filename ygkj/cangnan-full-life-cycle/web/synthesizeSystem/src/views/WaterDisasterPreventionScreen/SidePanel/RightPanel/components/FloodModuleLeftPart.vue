  ...
  <div class="collapse-panel__content">
    ...
    <panel-item title="大中型水库" hasSwitch>
      <template slot="title-switch">
        ...
        <i
          title="查看详表"
          @click="openDetailsDialog('水库', '大中型水库')"
        ...
        <i
          title="洪水预报弹窗"
          class="icon-hongshui-yubao icon-sty"
          @click="FloodForecasting"
        />
      </template>
      <!-- 当前出库水库 -->
              ...
              <div class="item-text">
                ...
                <p class="item-label">
                  ...
                  <span class="number">
                    {{
                      item.drainage24H
                        ? Number(item.drainage24H).toFixed(1)
                        : "0"
                    }} </span
                  >万m³
                </p>
    ...
    <panel-item title="水闸" hasSwitch>
      <template slot="title-switch">
        <i
          ...
          :class="[
            szbtn % 2 == 0 ? 'icon-yinzhang-active' : 'icon-yinzhang-1',
            'icon-sty',
          ]"
        />
        <i
      ...
      <div class="water-gate-sty">
        ...
        <div>
          <p>
            ...
            ><span style="line-height: 2.125rem">累计:</span>
            <el-input-number
              v-model="num"
              size="small"
              ...
              @change="changeHours"
            />
            <span style="font-size: 18px; color: #fff; line-height: 2.125rem"
              >小时</span
            >
          </p>
    ...
    >
      <template slot="title-switch">
        <i
          ...
          :class="[
            hwbtn % 2 == 0 ? 'icon-yinzhang-active' : 'icon-yinzhang-1',
            'icon-sty',
          ]"
        />
        <i
...
.collapse-panel__content {
  ...
  .water-gate-sty {
    padding: 10px;
    // margin-bottom: 10px;
    background: url(~assets/images/WaterDisastersImage/shui-zha.png) no-repeat
      top center;
    background-size: 100% 100%;
    > div:nth-child(1) {
      display: flex;
