          ...
          <panel-item title="水闸" has-switch>
            ...
            <div class="water-gate-sty">
              ...
              <div class="area-style">
                ...
                <p>
                  <i style="margin-right: 10px" class="icon-kai-qi-shu icon-sty"></i>已开启 <span> {{ wagaData.wrpOpenNum }} </span> 个
                </p>
              </div>
              <div class="area-style">
                <p>
              ...
              >
                ...
                <el-carousel-item>
                  ...
                  <el-row class="sea-level-style">
                    ...
                    <el-col
                      :span="8"
                      class="sea-level-sty sea-left-level-style"
                    >
                      <div class="sea-sty">
                        <p>
                          {{
  ...
  methods: {
    ...
    riverNetwork() {
      ...
      option = {
        ...
        tooltip:{
          show:true,
          formatter:function(data){
            let htmlText = `<p class="rivertooltip__item rivertooltip__item-error"><span>保证: </span><span>${data.data.guarantee}m</span></p>`
    ...
    handleWeakProjectChange(btnType) {
      ...
      for (let point of this.weakProjectList) {
        let imgSrc = require("@/assets/images/legend/legend-bxsk.png");
        if (point.projectType == "水库") {
          imgSrc = require("@/assets/images/legend/legend-bxsk.png");
        } else if (point.projectType == "海塘") {
          imgSrc = require("@/assets/images/legend/legend-bxht.png");
        } else if (point.projectType == "山塘") {
          imgSrc = require("@/assets/images/legend/legend-bxst.png");
        } else {
          imgSrc = require("@/assets/images/legend/legend-bxsz.png");
        }
        pointList.push({
          lng: point.longitude,
          lat: point.latitude,
      ...
      if (this.dangerouslyShow) {
        this.$emit("legend-change", "病险工程", {
          ...
          children: [
            ...
            { label: "病险水闸", icon: "icon-legend-bxsz" },
