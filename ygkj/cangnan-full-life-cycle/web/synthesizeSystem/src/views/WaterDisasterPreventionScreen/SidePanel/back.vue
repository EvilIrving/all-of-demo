...
.early-warning {
  ...
  height: 140px;
  background: url(~assets/images/WaterDisastersImage/shanhong-left.png) no-repeat top
    center;
  background-size: 100% 100%;
  position: relative;
  > div:nth-child(1) {
...
.warning-possibility {
  ...
  padding: 15px;
  color: #ff7144;
  background: url(~assets/images/WaterDisastersImage/shanghong-red.png) no-repeat top
    center;
  background-size: 100% 100%;
  > p:nth-child(1) {
    font-size: 18px;
