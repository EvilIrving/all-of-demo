        ...
        <div class="query-sty">
          ...
          <el-col :span="6" class="bb" style="margin-left: 15px">
            <div class="demo-input-suffix" style="margin-left: 0px">
              ...
              <el-input placeholder="名称" v-model="NameVal" class="mineClass" clearable @blur="queryVal" />
            </div>
          </el-col>
          <el-col :span="6" class="bb" style="margin-left: 15px">
        ...
        <div class="tab-list-sty">
          ...
          >
            ...
            >
              <template slot-scope="scope">
                <span>
                  {{scope.row.engScal == '1' ? '大（Ⅰ）型' : 
                    scope.row.engScal == '2' ? '大（Ⅱ）型' :  
                    scope.row.engScal == '3' ? '中型' :
                    scope.row.engScal == '4' ? '小（Ⅰ）型' : 
                  '小（Ⅱ）型'}}
                </span>
              </template>
            </el-table-column>
