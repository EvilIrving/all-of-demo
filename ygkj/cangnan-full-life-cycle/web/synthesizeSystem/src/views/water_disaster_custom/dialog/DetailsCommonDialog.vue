	...
	<div class="primary-dialog detail-table">
		...
		>
              ...
              <p><span>{{ statisticsData.avgLimitStorageAbility }} </span> 个</p>
				...
				<div class="statistics-sty" v-if="code == '潮位'">
					...
					<div>
						...
						<div>
							<p>超警戒统计</p>
							<p>
								<span>{{ seaLevelList.overWarnNum == null ? "-" : seaLevelList.overWarnNum }} </span>
								个
							</p>
						</div>
					</div>
				...
				<div class="statistics-sty" v-if="code == '防汛仓库'">
					...
					<div v-for="(item, key) in warehouseData.stats" :key="key">
						<p>
							<i :class="buildingTypeIconMap[item.key] ? buildingTypeIconMap[item.key] : 'icon-warehouse-tongji'"></i>
						</p>
						<div>
							<p>{{ item.key }}</p>
							<p>
				...
				<div class="statistics-sty" v-if="code == '防汛队伍'">
					...
					<div v-for="(item, key) in ranksData.stats" :key="key">
						<p>
							<i :class="buildingTypeIconMap[item.key] ? buildingTypeIconMap[item.key] : 'icon-team-tongji'" />
						</p>
						<div>
							<p>{{ item.key }}</p>
							<p>
				...
				<div class="statistics-sty" v-if="code == '水厂'">
					...
					<div>
						...
						<div>
							<p>千吨万人</p>
							<p>
								<span style="color: #008fe8"> {{ waterPointData["千吨万人"] || "-" }} </span>
								个
							</p>
						</div>
					</div>
					<div>
						...
						<div>
							<p>200吨~1000吨</p>
							<p>
								<span style="color: #6267ff"> {{ waterPointData["两百吨千人以上"] || "-" }} </span>
								个
							</p>
						</div>
					</div>
					<div>
						...
						<div>
							<p>200吨以下</p>
							<p>
								<span style="color: #a000c8"> {{ waterPointData["两百吨千人以下"] || "-" }} </span>
								个
							</p>
						</div>
					</div>
				...
				<div class="statistics-sty" v-if="code == '水源地'">
					...
					<div>
						...
						<div>
							<p>千吨万人</p>
							<p>
								<span style="color: #008fe8"> {{ wasuObjTypeData[1].num }} </span>
								个
							</p>
						</div>
					</div>
					<div>
						...
						<div>
							<p>200吨~1000吨</p>
							<p>
								<span style="color: #6267ff"> {{ wasuObjTypeData[2].num }} </span>
								个
							</p>
						</div>
					</div>
					<div>
						...
						<div>
							<p>200吨以下</p>
							<p>
								<span style="color: #a000c8"> {{ wasuObjTypeData[3].num }} </span>
								个
							</p>
						</div>
					</div>
				...
				<div class="statistics-sty" v-if="code == '水量预警'">
					...
					<div>
						...
						<div>
							<p>暂无风险</p>
							<p>
								<span style="color: #19af47"> {{ wasuObjTypeData[0].num }} </span>
								个
							</p>
						</div>
					</div>
					<div>
						...
						<div>
							<p>黄色预警</p>
							<p>
								<span style="color: #e89100"> {{ wasuObjTypeData[1].num }} </span>
								个
							</p>
						</div>
					</div>
					<div>
						...
						<div>
							<p>橙色预警</p>
							<p>
								<span style="color: #ff551f"> {{ wasuObjTypeData[2].num }} </span>
								个
							</p>
						</div>
					</div>
					<div>
						...
						<div>
							<p>红色预警</p>
							<p>
								<span style="color: #e80000"> {{ wasuObjTypeData[3].num }} </span>
								个
							</p>
						</div>
					</div>
				...
				<div class="statistics-sty" v-if="code == '取水户'">
					<div>
						...
						<div>
							...
							<p>
								<span>
									{{ wtaerIntakeCount.intakeSum && wtaerIntakeCount.intakeSum.toFixed(0) }}
								</span>
								户
							</p>
						</div>
				...
				<div class="statistics-sty" v-if="code == '水域变化'">
					<div>
						...
						<div>
							<p>水域面积</p>
							<p>
								<span> {{ Number(waterChangeCount.waterArea).toFixed(2) || "-" }} </span>
								k㎡
							</p>
						</div>
					</div>
					...
					<div>
						...
						<div>
							<p>补偿面积</p>
							<p>
								<span> {{ Number(waterChangeCount.compensationArea).toFixed(2) || "-" }} </span>
								k㎡
							</p>
						</div>
					</div>
				...
				<div class="beauty-tab-panel" v-if="code == '美丽河湖'">
					<div
						:class="['beauty-tab-item', activeTabBeauty == '美丽河湖' ? 'active' : '']"
						@click="changeActiveTabBeauty('美丽河湖')"
					>
						美丽河湖建设
					</div>
					<div
						:class="['beauty-tab-item', activeTabBeauty == '中小河流' ? 'active' : '']"
						@click="changeActiveTabBeauty('中小河流')"
					>
						中小河流治理
					</div>
					<div
						:class="['beauty-tab-item', activeTabBeauty == '水美乡镇' ? 'active' : '']"
						@click="changeActiveTabBeauty('水美乡镇')"
					>
						水美乡镇建设
					</div>
					<div
						:class="['beauty-tab-item', activeTabBeauty == '农村池塘' ? 'active' : '']"
				...
				<div class="statistics-sty" v-if="code == '海塘'">
					<div>
						...
						<div>
							<p>总长度</p>
							<p>
								<span> {{ seawallData.totalLength || "-" }} </span> km
							</p>
						</div>
					</div>
				...
				<div class="query-sty">
					...
					<el-row style="margin-top: 15px">
						...
						<el-col :span="6" class="aa" v-if="code == '风险隐患'">
							<div class="derive-sty mg-l16" style="width: 65px" @click="exportExcel('风险隐患')">
								导 出
							</div>
						</el-col>
                ...
                <el-input placeholder="请输入" v-model="affiliatedUnit" class="myClass" clearable @input="queryVal" />
						...
						<el-col :span="6" class="aa" v-if="code == '短临预报'">
							<div class="demo-input-suffix">
								...
								<el-select v-model="rainfallType" size="small" placeholder="全部" @input="selectVal">
									<el-option v-for="item in rainfalStration" :key="item.name" :label="item.name" :value="item.name" />
								</el-select>
							</div>
						</el-col>
						<el-col :span="18" class="aa" v-if="code == '短临预报'">
							<div class="derive-sty mg-l16" style="width: 65px" @click="exportExcel('短临预报')">导 出</div>
						</el-col>
						<!-- 设计防潮标准年限 -->
						...
						<!-- 行政区划 固定 -->
						<el-col :span="6" class="aa" v-if="!hideAdcdFilterCodes.includes(code)">
							<div class="demo-input-suffix">
								<p style="width: 100px">行政区划：</p>
						...
						<!-- 流域 -->
						<el-col :span="6" class="aa" v-if="!hideBasinFilterCodes.includes(code)">
							<div class="demo-input-suffix">
						...
						<el-col :span="6" v-if="code == '水库'">
							<div class="demo-input-suffix">
								...
								<el-select v-model="projectScaleValue" size="small" @input="selectVal">
									<el-option v-for="item in projectScaleData" :key="item.name" :label="item.name" :value="item.name" />
								</el-select>
							</div>
						</el-col>
						<!-- 水闸工程规模 -->
						<el-col :span="6" v-if="code == '水闸'">
							<div class="demo-input-suffix">
								<p style="width: 100px">工程规模：</p>
								<el-select v-model="engScalesValue" size="small" clearable placeholder="全部" @input="selectVal">
									<el-option v-for="item in engScalesData" :key="item.name" :label="item.name" :value="item.name" />
								</el-select>
							</div>
						</el-col>
						<!-- 海塘 -->
						...
						<el-col :span="6" v-if="code == '病险工程' || code == '视频监控'">
							<div class="demo-input-suffix">
								...
								<el-select v-model="projType" size="small" clearable placeholder="全部" @input="selectVal">
						...
						<el-col :span="6" v-if="code == '视频监控'">
							<div class="mg-l16 demo-input-suffix">
								<p style="width: 100px">视频状态:</p>
								<el-select v-model="statusType" size="small" clearable placeholder="全部" @input="selectVal">
              ...
              <div class="demo-input-suffix">
                ...
                >
                  搜 索
						...
						<el-col :span="10" class="aa" v-if="code == '规划'">
							<div class="demo-input-suffix">
								...
								<el-date-picker
									...
									clearable
									:picker-options="{
										disabledDate: time => (planEnd ? time.getFullYear() > planEnd : null)
									}"
									@change="selectVal"
								/>
								至
								<el-date-picker
									...
									clearable
									:picker-options="{
										disabledDate: time => (planStart ? time.getFullYear() < planStart : null)
									}"
									@change="selectVal"
								/>
							</div>
						...
						<el-col :span="6" v-if="showSerachCodes.includes(code)">
							<div class="demo-input-suffix">
								...
								/>
								<div
									v-if="code == '海塘' || code == '积水' || code == '水闸' || code == '水库'"
									class="derive-sty mg-l16"
									style="width: 65px"
						...
						<el-col :span="6" v-if="code == '河网'">
							<div class="derive-sty mg-l16" style="width: 65px" @click="exportExcel('河网')">
								导 出
							</div>
							<div class="derive-sty mg-l16" style="width: 80px" @click="searchVal">
								查 询
							</div>
						</el-col>
					</el-row>

					<!-- 降水量，水资源量，供水量，用水量（公报）开始 -->
					<el-row v-if="code == '供水量（公报）'">
						<el-col :span="24" class="water-supply-select-panel">
							<div
								:class="[activeTab == '供水总量' ? 'active' : '', 'water-supply-select-btn']"
								@click="changeActiveTab('供水总量')"
							>
								供水总量
							</div>
							<div
								:class="[activeTab == '供水工程' ? 'active' : '', 'water-supply-select-btn']"
								style="cursor: not-allowed"
								@click="changeActiveTab('供水工程')"
							>
								供水工程
							</div>
						</el-col>
					...
					<el-row v-if="code == '水资源承载能力'">
						<el-col :span="24" class="water-supply-select-panel">
							<div
								:class="[activeTabCarry == '水量评价' ? 'active' : '', 'water-supply-select-btn']"
								@click="changeActiveTabCarry('水量评价')"
							>
								水量评价
							</div>
							<div
								:class="[activeTabCarry == '水质评价' ? 'active' : '', 'water-supply-select-btn']"
								@click="changeActiveTabCarry('水质评价')"
							>
								水质评价
							</div>
							<div
								:class="[activeTabCarry == '经济评价' ? 'active' : '', 'water-supply-select-btn']"
								@click="changeActiveTabCarry('经济评价')"
							>
								经济评价
							</div>
							<div
								:class="[activeTabCarry == '人口评价' ? 'active' : '', 'water-supply-select-btn']"
							...
							<!-- <div
                :class="[
                  activeTabCarry == '用水评价' ? 'active' : '',
                  'water-supply-select-btn',
                ]"
                @click="changeActiveTabCarry('用水评价')"
              >
                用水评价
              </div> -->
						</el-col>
						...
						<el-col :span="8">
							<div class="demo-input-suffix">
								...
								<el-input
									...
									style="width: 180px"
								></el-input>
								<div class="derive-sty mg-l16" style="width: 80px" @click="getEarlyDetail">
									查 询
								</div>
							</div>
						</el-col>
					...
					<el-row :gutter="20" v-if="code == '水源地'">
						...
						<el-col :span="6">
							<div class="demo-input-suffix">
								<p style="width: 80px">关键字：</p>
								<el-input v-model="waterSourSearchVal" placeholder="请输入内容" @input="getWaterSourList"></el-input>
							</div>
						</el-col>
					</el-row>
					<!-- 水厂 水厂运行状态 筛选项 -->
					<el-row :gutter="20" v-if="code == '水厂' || code == '水厂运行状态'">
						...
						<el-col :span="6">
							<div class="demo-input-suffix">
								<p style="width: 80px">关键字：</p>
								<el-input v-model="cwsName" placeholder="请输入内容" @input="AttSwhsBaseLoadPage"></el-input>
							</div>
						</el-col>
					</el-row>
					...
					<el-row :gutter="20" v-if="code == '水量预警'">
						...
						<el-col :span="6">
							<div class="demo-input-suffix">
								<p style="width: 80px">关键字：</p>
								<el-input v-model="waterSourSearchVal" placeholder="请输入内容" @input="getWaterWarnList"></el-input>
							</div>
						</el-col>
					</el-row>
					...
					<el-row :gutter="20" v-if="code == '珊溪水质监测'">
						...
						<el-col :span="6">
							<div class="demo-input-suffix">
								<p style="width: 80px">关键字：</p>
								<el-input v-model="shanXiWaterSearchVal" placeholder="请输入内容" @input="getSXWaterList"></el-input>
							</div>
						</el-col>
					</el-row>
					...
					<el-row :gutter="20" v-if="code == '巡查'">
						...
						<el-col :span="6">
							<div class="demo-input-suffix">
								...
								<el-input v-model="chaosName" placeholder="请输入内容" @input="happeningListJson"></el-input>
							</div>
						</el-col>
					</el-row>
						...
						<el-col :span="8" style="margin-top: 10px">
							<div class="demo-input-suffix">
								...
								<el-input
									...
									style="width: 176px"
								></el-input>
								<div class="derive-sty mg-l16" style="width: 80px" @click="getFourChaosList">
									查 询
								</div>
							</div>
						</el-col>
					...
					<el-row :gutter="20" v-if="code == '水电站'">
						...
						<el-col :span="6">
							<div class="demo-input-suffix">
								...
								></el-input>
								<div class="derive-sty mg-l16" style="width: 80px" @click="getHydropowerStationList">
									查 询
								</div>
							</div>
						</el-col>
				...
				<div class="tab-list-sty" v-if="code == '水库'">
					...
					>
						...
						<el-table-column
							...
							label="鉴定时间"
						/>
						<el-table-column :formatter="toFixedFormatter" prop="safetyConclusion" width="110" label="鉴定结论" />
						<el-table-column :formatter="toFixedFormatter" prop="reinforce" width="110" label="有无加固" />
						<el-table-column
							v-if="projectScaleValue != '大中型'"
							:formatter="toFixedFormatter"
				...
				<div class="tab-list-sty" v-if="code == '水闸'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" :sortable="'custom'" prop="wagaName" label="名称" />
						<el-table-column :show-overflow-tooltip="true" :formatter="toFixedFormatter" prop="bas" label="流域" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							width="80"
						...
						<el-table-column
							...
							label="工程规模"
						/>
						<el-table-column :show-overflow-tooltip="true" :sortable="'custom'" width="130" label="闸上水位(m)">
							<template #default="{row}">
								{{ !row.upz ? "-" : row.upz > 10 ? "故障" : row.upz }}
							</template>
						</el-table-column>
						<el-table-column :show-overflow-tooltip="true" :sortable="'custom'" width="130" label="闸下水位(m)">
							<template #default="{row}">
				...
				<div class="tab-list-sty" v-if="code == '河网'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="rnName" width="80" label="名称" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							prop="bas"
				...
				<div class="tab-list-sty" v-if="code == '病险工程'">
					...
					>
						...
						/>
						<el-table-column :show-overflow-tooltip="true" :formatter="toFixedFormatter" prop="bas" label="流域" />
						<el-table-column :show-overflow-tooltip="true" :formatter="toFixedFormatter" prop="adnm" label="行政区划" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							prop="engScal"
				...
				<div class="tab-list-sty" v-if="code == '风险隐患'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="projName" label="名称" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							prop="projType"
				...
				<div class="tab-list-sty" v-if="code == '短临预报'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="key" label="名称" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="Formatter"
							sortable
				...
				<div class="tab-list-sty" v-if="code == '防汛仓库'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="name" label="物资点名称" sortable />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							prop="areaName"
							...
							sortable
						/>
						<el-table-column :show-overflow-tooltip="true" :formatter="toFixedFormatter" prop="type" label="仓库类型" />
						<el-table-column :show-overflow-tooltip="true" :formatter="toFixedFormatter" prop="address" label="地址" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							prop="materialPrice"
				...
				<div class="tab-list-sty" v-if="code == '防汛队伍'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="name" label="抢险队伍名称" sortable />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							prop="areaName"
				...
				<div class="tab-list-sty" v-if="code == '视频监控'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="cameraName" label="摄像头名称" sortable />
						<el-table-column :show-overflow-tooltip="true" :formatter="toFixedFormatter" prop="adnm" label="行政区划" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
						...
						>
							<template slot-scope="scope">
								<span> {{ scope.row.status == 0 ? "离线" : scope.row.status == 1 ? "在线" : "-" }}</span>
							</template>
						</el-table-column>
					</el-table>
					<!-- 分页 -->
				...
				<div class="tab-list-sty" v-if="code == '积水'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="name" label="积水点名称" sortable />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							prop="areaName"
				...
				<div class="tab-list-sty" v-if="code == '洪水风险图'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="name" label="流域名称" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							prop="designStandard"
				...
				<!-- 降水量（公报） tab列表 -->
				<div class="tab-list-sty" v-if="code == '降水量（公报）'">
					<el-table
						ref="multipleTable"
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="adnm" label="行政区域" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							prop="rainfall"
				...
				<!-- 水资源量（公报） tab列表 -->
				<div class="tab-list-sty" v-if="code == '水资源量（公报）'">
					<el-table
						ref="multipleTable"
				...
				<!-- 供水量（公报） tab列表 -->
				<div class="tab-list-sty" v-if="code == '供水量（公报）'">
					<el-table
						ref="multipleTable"
            ...
            /> -->
				...
				<!-- 用水量（公报） tab列表 -->
				<div class="tab-list-sty" v-if="code == '用水量（公报）'">
					<el-table
						ref="multipleTable"
						:data="waterUseData"
						height="100%"
				...
				<!-- 水库蓄水量（公报） tab列表 -->
				<div class="tab-list-sty" v-if="code == '水库蓄水量（公报）'">
					<el-table
						ref="multipleTable"
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="resName" label="水库名称" />
						<!-- <el-table-column
              :show-overflow-tooltip="true"
              :formatter="toFixedFormatter"
              prop="currentStore"
            ...
            /> -->
				...
				<!-- 水资源承载能力 水量评价 tab列表 -->
				<div class="tab-list-sty" v-if="code == '水资源承载能力' && activeTabCarry == '水量评价'">
					<el-table
						ref="multipleTable"
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="adnm" label="行政区划" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedTwoFormatter"
							prop="consumeTotal"
				...
				<!-- 水资源承载能力 水质评价 tab列表 -->
				<div class="tab-list-sty" v-if="code == '水资源承载能力' && activeTabCarry == '水质评价'">
					<el-table
						ref="multipleTable"
						:data="waterResCarryData"
						height="100%"
				...
				<!-- 水资源承载能力 经济评价 tab列表 -->
				<div class="tab-list-sty" v-if="code == '水资源承载能力' && activeTabCarry == '经济评价'">
					<el-table
						ref="multipleTable"
						:data="waterResCarryData"
						height="100%"
				...
				<!-- 水资源承载能力 人口评价 tab列表 -->
				<div class="tab-list-sty" v-if="code == '水资源承载能力' && activeTabCarry == '人口评价'">
					<el-table
						ref="multipleTable"
						:data="waterResCarryData"
						height="100%"
				...
				<!-- 水资源承载能力 用水评价 tab列表 -->
				<div class="tab-list-sty" v-if="code == '水资源承载能力' && activeTabCarry == '用水评价'">
					<el-table
						ref="multipleTable"
						:data="waterResCarryData"
						height="100%"
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="resName" label="行政区划" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							prop="currentStore"
				...
				<div class="tab-list-sty" v-if="code == '预警信息'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="type" label="预警类型" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							prop="content"
				...
				<div class="tab-list-sty" v-if="code == '流域生态流量'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="sectName" label="断面名称" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							prop="bas"
				...
				<div class="tab-list-sty" v-if="code == '规划'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="projName" label="项目名称" />
						<el-table-column :show-overflow-tooltip="true" prop="projDuration" label="起止年份" />
						<el-table-column :show-overflow-tooltip="true" prop="constructContent" label="主要建设内容" />
						<el-table-column label="总投资(万元)" prop="amountInvestTotal" />
						<el-table-column :label="`${mediumSized.split('|')[0]}投资(万元)`" prop="amountInvestDevelop" />
						<el-table-column label="已完成投资(万元)" prop="amountInvested" />
						<el-table-column label="结转总投资(万元)" prop="amountInvestIndirect" />
					</el-table>
				</div>
				<!-- 水厂 tab列表 -->
				<div class="tab-list-sty" v-if="code == '水厂'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="cwsName" label="水厂名称" />
						<el-table-column :show-overflow-tooltip="true" :formatter="toFixedFormatter" prop="adnm" label="行政区划" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
						...
						<el-table-column
							...
							sortable
						/>
						<el-table-column :show-overflow-tooltip="true" :formatter="toFixedFormatter" prop="engType" label="类型" />
						<!-- <el-table-column
              :show-overflow-tooltip="true"
              :formatter="toFixedFormatter"
              prop="cumulatAnnWain"
            ...
            /> -->
				...
				<div class="tab-list-sty" v-if="code == '水厂运行状态'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" :formatter="toFixedFormatter" label="pH" sortable>
							<template slot-scope="scope">
								<span style="color:#EF1313;">{{ scope.row.phValue || "-" }}</span>
							</template>
						</el-table-column>
						<el-table-column
							:show-overflow-tooltip="true"
				...
				<div class="tab-list-sty" v-if="code == '水源地'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="swhsName" label="水源地名称" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							prop="adnm"
							label="水源地位置"
						/>
						<el-table-column :show-overflow-tooltip="true" :formatter="toFixedFormatter" label="类型">
							<template slot-scope="scope">
								<span>{{
				...
				<div class="tab-list-sty" v-if="code == '水量预警'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" :formatter="toFixedFormatter" label="水量预警等级" sortable>
							<template slot-scope="scope">
								<span
									:style="{
										color:
				...
				<div class="tab-list-sty" v-if="code == '珊溪水质监测'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="type" label="站点名称" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							prop="content"
							...
							sortable
						/>
						<el-table-column :show-overflow-tooltip="true" :formatter="toFixedFormatter" prop="sendTime" label="COD" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							prop="destinationUserName"
				...
				<div class="tab-list-sty" v-if="code == '巡查'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="chaosName" label="乱点名称" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							prop="chaosType"
				...
				<div class="tab-list-sty" v-if="code == '取水户'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="wiuName" label="名称" width="180" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							prop="areaName"
				...
				<div class="tab-list-sty" v-if="code == '批后监管'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="projectName" label="项目名称" width="200" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							prop="projectCode"
						...
						/>
						<el-table-column :show-overflow-tooltip="true" :formatter="toFixedFormatter" prop="adnm" label="行政区划" />
						<el-table-column :show-overflow-tooltip="true" :formatter="toFixedFormatter" prop="year" label="年份" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							prop="riverName"
				...
				<div class="tab-list-sty" v-if="code == '水域变化'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="areaName" label="行政区划" />
						<el-table-column :show-overflow-tooltip="true" :formatter="toFixedFormatter" prop="year" label="年份" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedTwoFormatter"
				...
				<div class="tab-list-sty" v-if="code == '清四乱'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="riverName" label="问题河道" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							prop="address"
							...
							width="180"
						/>
						<el-table-column :show-overflow-tooltip="true" :formatter="toFixedFormatter" prop="status" label="问题状态">
							<template slot-scope="scope">
								<span v-if="scope.row.status == '0'" style="color: #f2a600">未处理</span>
								<span v-if="scope.row.status == '1'" style="color: #1ef8f2">已处理</span>
								<span v-if="scope.row.status == '2'" style="color: #ff0000">逾期未处理</span>
								<span v-if="scope.row.status == '3'" style="color: #c60000">驳回</span>
							</template>
						</el-table-column>
						<el-table-column
							:show-overflow-tooltip="true"
				...
				<!-- 美丽河湖 tab列表 -->
				<div class="tab-list-sty" v-if="code == '美丽河湖'" style="padding-bottom: 0;">
					<el-table
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="projectName" label="项目名称" width="76" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							prop="projectStatus"
				...
				<div class="tab-list-sty" v-if="code == '水电站'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="hystName" label="水电站名称" width="150" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							prop="hystCode"
						...
						<el-table-column
							...
							width="150"
						>
							<template slot-scope="scope">{{ getHydroType(scope.row.hystType) }}</template>
						</el-table-column>
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
						...
						<el-table-column
							...
							width="150"
						>
							<template slot-scope="scope">{{ (scope.row.standardRate * 100).toFixed(2) }}%</template>
						</el-table-column>
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							...
							width="120"
						>
							<template slot-scope="scope">{{ (scope.row.onlineRate * 100).toFixed(2) }}%</template>
						</el-table-column>
					</el-table>
					<el-pagination
						background
				...
				<div class="tab-list-sty" v-if="code == '河长巡查'">
					...
					>
						...
						<el-table-column
							...
							label="问题程度"
						>
							<template slot-scope="scope">{{ getProblemType(scope.row.level) }}</template>
						</el-table-column>
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
						...
						<el-table-column
							...
							width="80"
						>
							<template slot-scope="scope">{{ getProblemStatu(scope.row.state) }}</template>
						</el-table-column>
					</el-table>
					<el-pagination
						background
				...
				<div class="tab-list-sty" v-if="mediumSized == '防御复盘' && code == '水库分析'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" sortable prop="resName" label="名称" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="Formatter"
							sortable
				...
				<div class="tab-list-sty" v-if="mediumSized == '防御复盘' && code == '水闸分析'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" sortable prop="wagaName" label="名称" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="Formatter"
							sortable
				...
				<div class="tab-list-sty" v-if="mediumSized == '防御复盘' && code == '河网分析'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" sortable prop="rnName" label="名称" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="toFixedFormatter"
							:sortable="'custom'"
				...
				<div class="tab-list-sty" v-if="mediumSized == '防御复盘' && code == '潮位分析'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" sortable prop="stName" label="名称" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="Formatter"
							sortable
				...
				<div class="tab-list-sty" v-if="mediumSized == '防御复盘' && code == '水利设施保险'">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" sortable prop="name" label="合同编号" />
						<el-table-column :show-overflow-tooltip="true" sortable prop="name" label="合同名称" />
						<el-table-column
							:show-overflow-tooltip="true"
							:formatter="Formatter"
							sortable
...
export default {
	...
	data() {
		return {
			...
			checkYear: "",
			precipitationData: [], // 降水量（公报）
			waterResourceData: [], // 水资源量（公报）
			activeTab: "供水总量", // 供水量tab 供水总量/供水工程
			activeTabCarry: "水量评价", // 水资源承载能力tab
			waterRupplyData: [], // 供水量（公报）
			waterUseData: [], // 用水量（公报）
	...
	computed: {
		...
		hideAdcdFilterCodes() {
			// prettier-ignore
			return ['短临预报','水利设施保险','水库分析','水闸分析','河网分析','潮位分析','风险隐患','洪水风险图','降水量（公报）','水资源量（公报）','供水量（公报）','用水量（公报）','水库蓄水量（公报）','水资源承载能力','流域生态流量','预警信息','水源地','水量预警','珊溪水质监测','巡查','取水户','批后监管','水域变化','清四乱','美丽河湖','水电站','河长巡查']
		},
		/** 没有流域筛选的 */
		hideBasinFilterCodes() {
			...
			return ['山洪','短临预报','风险隐患','海塘','水利设施保险','水库分析',
					...
					'积水','洪水风险图','降水量（公报）','水资源量（公报）','供水量（公报）',
					'用水量（公报）','水库蓄水量（公报）','水资源承载能力','预警信息','规划',
		...
		showSerachCodes() {
			// prettier-ignore
			return ['水库','水闸','河网','潮位','病险工程','积水','海塘','防汛仓库','防汛队伍','流域生态流量','水库蓄水量（公报）','规划']
		},
		startTime() {
