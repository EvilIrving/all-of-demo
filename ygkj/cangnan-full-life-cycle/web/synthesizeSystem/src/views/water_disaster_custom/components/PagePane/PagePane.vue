...
export default {
  ...
  methods: {
    ...
    renderTitle() {
      ...
      const slotAppend = <div class="pane-title__append">{this.$slots.append}</div>;
  ...
  render() {
    const panes = (
      <div class={["page-pane__content", this.panes.length > 0 && "has-pane"]}>
        {this.$slots.default}
      </div>
    );
    return (
