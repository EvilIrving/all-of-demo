  ...
  <div class="big-card">
    <panel-item title="大中型水库" hasSwitch tc @tclick="tclick">
      <template slot="title-switch">
        ...
        <i
          title="查看详表"
          @click.stop="openDetailsDialog('水库', '大中型水库')"
      ...
      <div class="reservoir-sty">
        <p>
          ...
          <span>
            <span
              style="color: #1cfff5; font-size: 24px; line-height: 24px; margin: 0 5px"
            >
            ...
            <div class="flood-discharge-item__content">
              ...
              <div class="item-text">
                ...
                <p class="item-label">
                  ...
                  <span class="number">
                    {{
                      item.drainage24H ? Number(item.drainage24H).toFixed(1) : "0"
                    }} </span
                  >万m³
                </p>
              </div>
...
.big-card {
  ...
  .reservoir-sty {
    ...
    // }
    > p:nth-child(2) {
      background: url(~assets/images/WaterDisastersImage/bg-ji-shui.png) no-repeat top
        center;
