<!--
 * @Autor: ysl
 * @Date: 2021-08-12 09:12:38
 * @LastEditors: ysl
 * @LastEditTime: 2021-08-14 13:45:48
 * @Description: 节水行动态势
 * @FilePath: /synthesizeSystem/src/views/water_disaster_custom/cards/WaterSavingActionSituationCard.vue
-->
<template>
...
export default {
	...
	methods: {
		 ...
		 */
		openDetailsDialog() {
			this.$emit("openDialog", this.activeTab);
		},
		// 标题点击打开统计卡片
		tclick(title) {
				...
				tooltip: {
					...
					formatter: function(data) {
						return (
							data[0].name +
							"<br/><span>" +
							_this.filterTypeOptions[_this.checkType].label +
							"：</span>" +
							data[0].value +
							"<span>" +
							_this.filterTypeOptions[_this.checkType].unit +
							"</span>" +
							"<br/>十四五控制指标：" +
