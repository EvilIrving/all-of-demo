			...
			<div class="primary--dialog__content">
				...
				<div class="tab-list-sty" style="padding-bottom: 20px">
					...
					>
						...
						<el-table-column label="预报发布时间" />
						<el-table-column label="洪峰水位(m)" />
						<el-table-column label="洪峰水位出现时间" />
						<el-table-column label="洪峰流量" />
						<el-table-column label="洪峰流量出现时间" />
					</el-table>
				</div>
			</div>
		</el-dialog>
...
<script>
import { getHydrologyData, getTideData, getHydrologyForecast } from "@/api/hydrology-digitization/index.js";
