    ...
    <page-pane title="数据责任" @onTitle="() => {}">
      ...
      <div class="custom-legend-chart">
        ...
        <div class="custom-legend" style="height: 160px">
          <ul class="list">
            <li
              v-for="(item, index) in respDistributedData.rows"
              :key="index"
              class="list-item"
            >
              <i
                class="dot"
                :style="{ backgroundColor: respDistributedColor[index] }"
              />
      ...
      <div class="custom-legend-chart">
        ...
        <div class="custom-legend" style="height: 160px">
          <ul class="list">
            <li
              v-for="(item, index) in resDeptData.rows"
              :key="index"
              class="list-item"
            >
              <i
                ...
                :style="{
                  backgroundColor:
                    respDistributedColor[
                      index >= respDistributedColor.length
                        ? index % respDistributedColor.length
                        : index
                    ],
                }"
...
import { getDataAndDuty, getDetaiList, getDutyDataDistribute, getDutyManDistribute } from "@/api/data-management/index.js";
