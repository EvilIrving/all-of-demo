 ...
 * @LastEditTime: 2021-07-21 15:55:22
 * @LastEditors: Please set LastEditors
 * @Description: 视频监控卡片
 * @FilePath: \synthesizeSystem\src\views\water_disaster_custom\cards\VideoCard.vue
-->
<template>
    ...
    >
      <template slot="title-switch">
        <i
          ...
          :class="[
            spbtn == true ? 'icon-yinzhang-active' : 'icon-yinzhang-1',
            'icon-sty',
          ]"
        />
        <i
      ...
      <div class="type-box" v-if="activeTab == 1">
        <div class="pie-box">
          <EchartPie
            :seriesData="typePieData"
            :extraOption="typePieOption"
          ></EchartPie>
        </div>
      ...
      <div class="status-box" v-if="activeTab == 2">
        <div class="pie-box">
    ...
    async _countCameraStatus() {
      ...
      for (let item of res.data) {
        rows.push({
          ...
          color: item.status == 0 ? "#1CFFF5" : "#FF7144 ",
        });
      }
      rows.push({
        name: "",
