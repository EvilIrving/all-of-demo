          ...
          <el-col :span="24">
            ...
            <el-row style="margin:15px 0;">
              <el-col :span="5">
                ...
                <el-select v-model="researchTypeId" multiple collapse-tags placeholder="请选择" @change="researchChange">
                  <el-option v-for="item in options" :key="item.id" :label="item.name" :value="item.id" />
                </el-select>
              </el-col>
              <el-col :span="16">
                <span style="color: #FFFFFF;">时间筛选：</span>
                <el-date-picker v-model="startYear" value-format="yyyy" style="width:220px;" type="year" placeholder="起始年份" @change="dateList" /> 
                <span style="text-align: center; width:30px;color:#fff;"> 至 </span>
                <el-date-picker v-model="endYear" value-format="yyyy" style="width:220px;" type="year" placeholder="终止年份" @change="dateList" />
              </el-col>
            </el-row>
            <!-- 研究类别统计 -->
            <table-title title="研究年份分析" />
            <div class="orientation">
              <div style="margin-top:10px;">
                <span :class=" switchNum == 1 ? 'switch-sty' : 'tab-sty'" @click="achievement">成果统计</span>
                <span :class=" switchNum == 2 ? 'switch-sty' : 'tab-sty'" @click="expenditure">经费统计</span>
              </div>
            </div>
            <!-- 柱状, 折线图 -->
            <div id="histogramChart" style="width:100%;height:400px;margin-bottom:20px;" />
          </el-col>
        </el-row>
      </div>
    </el-dialog>
