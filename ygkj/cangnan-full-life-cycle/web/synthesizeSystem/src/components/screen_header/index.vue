...
export default {
  ...
  data() {
    return {
      ...
      dialogVisible: false,
      menuList: [
        { title: "水灾害防御", path: "/waterDisasterCustom?bsType=waterDisaster&large=false&isBigScreen=false" },
        { title: "水资源保障", path: "/waterDisasterCustom?bsType=waterResource&large=false&isBigScreen=false" },
        { title: "河湖库保护", path: "/waterDisasterCustom?bsType=riverProtect&large=false&isBigScreen=false" },
        { title: "水发展规划", path: "/waterDisasterCustom?bsType=waterDevelop&large=false&isBigScreen=false" },
        { title: "水事务监管", path: "/waterDisasterCustom?bsType=waterAffair&large=false&isBigScreen=false" },
        { title: "水政务协同", path: "/waterDisasterCustom?bsType=waterGovernment&large=false&isBigScreen=false" },
