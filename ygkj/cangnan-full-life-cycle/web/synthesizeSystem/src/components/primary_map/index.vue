    ...
    init() {
      ...
      window["mapObj"] = new Map({
        ...
        layers: [
          new TileLayer(
            {
              ...
              source: new XYZ({
                url:
                  "https://t0.tianditu.gov.cn/DataServer?T=img_c&X={x}&Y={y}&L={z}&tk=2eeb2384fab6fcc8f96762c31bd0563b",
                projection: "EPSG:4326",
              }),
            },
            { zoomOffset: 1 }
          ...
          new TileLayer(
            {
              source: new XYZ({
                url:
                  mapConfig.mapServer + "2017%E6%B8%A9%E5%B7%9E%E5%8E%BF%E7%95%8C/MapServer/tile/{z}/{y}/{x}",
                projection: "EPSG:4326",
              }),
            },
            { zoomOffset: 1 }
          ...
          //     source: new XYZ({
          //       url:
          //         mapConfig.mapServer + "wenzhou/2017wenzhou_border2/MapServer/tile/{z}/{y}/{x}",
          //       projection: "EPSG:4326",
          //     }),
          //   },
          //   { zoomOffset: 1 }
          ...
          //     source: new XYZ({
          //       url:
          //         mapConfig.mapServer + "%E6%B8%A9%E5%B7%9E%E5%B8%82%E7%95%8C/MapServer/tile/{z}/{y}/{x}",
          //       projection: "EPSG:4326",
          //     }),
          //   },
          //   { zoomOffset: 1 }
