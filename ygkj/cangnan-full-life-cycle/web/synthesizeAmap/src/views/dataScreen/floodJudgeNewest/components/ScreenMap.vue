...
import { drawJgRainPoint,liftWaterloggingStationPoint,riverStationPoint,seaLevelStationPoint,sluiceStationPoint,setReservoirPoint } from "@/utils/mapUtil.js";
    ...
    lodeRiverFeatureLayers(data){
      ...
      let vectorSource = new VectorSource({
          loader: function (extent, resolution, projection) {
              var url = riverLayesBaseService +layerDataSet+"/MapServer/"+ data.index +
              '/query/?f=json&' +
