          ...
          <div class="custom-filter" v-if="projectType == '水库'">
            <div class="filter-item">
              ...
              <div>
                <el-radio-group
                  v-model="radioVal"
                  @change="getProjectList(projectType)"
                >
                  <el-row>
                    <el-col :span="8">
    ...
    <div class="statistics-list" ref="statisticsList" :style="listStyle">
      <div class="catalog-title" ref="catalogTitle">
        <div class="type-area">
          <div class="tab-area">
            <div
              :class="tabType == '总数' ? 'tab-active' : ''"
              @click="changeLayerType('总数')"
              class="tabList"
            >
              <div>
            ...
            <div
              :class="tabType == '病险' ? 'tab-active' : ''"
              @click="changeLayerType('病险')"
              v-if="
                projectType == '水库' ||
                projectType == '海塘' ||
                projectType == '水闸' ||
