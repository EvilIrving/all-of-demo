    ...
    <div class="statistics-sty" v-if="projType == '灌区'">
      ...
      <div>
        ...
        <div>
          <p>有效灌溉总面积</p>
          <p>
            <span style="color: #19af47">{{ dataCount.effIrrArea }} </span> ㎡
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="scope-content">
      <div class="table-box">
        <div class="select-group">
          ...
          <div class="select-box" v-if="projType == '防汛仓库'">
            仓库类型:
            <el-select
