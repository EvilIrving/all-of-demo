...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      this.getPubKey(() => {
        ////////////////////////////////// 请自行修改以下变量值	////////////////////////////////////
        var appkey = "22426366"; //综合安防管理平台提供的appkey，必填
        var secret = this.setEncrypt("Auy3clSTU6ipKGkeigB5"); //综合安防管理平台提供的secret，必填
        var ip = "10.33.158.145"; //综合安防管理平台IP地址，必填
        var playMode = 0; //初始播放模式：0-预览，1-回放
        var port = 6443; //综合安防管理平台端口，若启用HTTPS协议，默认443
