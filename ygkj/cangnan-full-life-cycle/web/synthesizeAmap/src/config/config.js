...
const testService = "http://192.168.0.32:8090/"; //hc
// const testService = "http://192.168.0.66:8090"; //lxl
const test3Service = "http://192.168.0.101:8090"; //lxl
...
const config = {
    ...
    fileUploadUrl: process.env.NODE_ENV === "production" ?
        "/api/auth-service/upload" : Service + "auth-service/upload",
};
