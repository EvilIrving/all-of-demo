 ...
 * @Author: 
 * @Description: 水库风险管控清单详情弹窗的内容
 * @LastEditors: wqn
 * @LastEditTime: 2023-02-20 17:52:07
 * @FilePath: \proyp-screen\src\views\reservoir\cpns\ReservoirDetailedListDialog.vue
-->
<template>
  <div class='dialog-content'>
    <div class="filter-box">
      <list-dialog-admn-select projectCategory="水库" v-model="adcd" @change="changeAdcd" />
    ...
    <div class="title">水库重点风险管控清单</div>
...
export default {
  name: "ReservoirDetailedListDialog",
  props: {},
  components: {},
  data() {
    return {
