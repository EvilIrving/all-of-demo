 ...
 * @returns 
 */
export function moistureproofAnalysisStatisticApi (planId, adcd, basin) {
  return axios.post('/mgt/bm/seawallei/getStatisticBigScreen', {
    statistic: 'forecast',
    itemCategory: 'planId',
    itemValue: planId,
    adcd,
 ...
 * @returns 
 */
export function moistureproofAnalysisOverCntMapListApi (planId, adcd, basin) {
  return axios.post('/mgt/bm/seawallei/getStatisticBigScreen', {
    statistic: 'mapList',
    itemCategory: 'forecast,planId',
    itemValue: 'overCnt,' + planId,
    adcd,
    basin
  })
}
 ...
 * @returns 
 */
export function moistureproofAnalysisSickCntMapListApi (planId, adcd, basin) {
  return axios.post('/mgt/bm/seawallei/getStatisticBigScreen', {
    statistic: 'mapList',
    itemCategory: 'forecast,planId',
    itemValue: 'sickCnt,' + planId,
    adcd,
    basin
  })
}
 ...
 * @returns 
 */
export function moistureproofAnalysisOverTopMapListApi (planId, adcd, basin) {
  return axios.post('/mgt/bm/seawallei/getStatisticBigScreen', {
    statistic: 'mapList',
    itemCategory: 'forecast,planId',
    itemValue: 'overTop,' + planId,
    adcd,
    basin
  })
}
